...
export declare namespace apihub_v1 {
    ...
    export interface Schema$GoogleCloudApihubV1Addon {
         ...
         */
        boostSpecGeminiRegionId?: string | null;
        /**
    ...
    export class Resource$Projects$Locations$Addons {
         ...
         *   // Example response
         *   // {
         *   //   "boostSpecGeminiRegionId": "my_boostSpecGeminiRegionId",
         *   //   "config": {},
    ...
    export class Resource$Projects$Locations$Apihubinstances {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Apihubinstances$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Apihubinstances$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleLongrunningOperation>>;
        patch(params: Params$Resource$Projects$Locations$Apihubinstances$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Apihubinstances$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunningOperation>, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        patch(params: Params$Resource$Projects$Locations$Apihubinstances$Patch, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
    ...
    export class Resource$Projects$Locations$Servers {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        configureAndDeployServer(params: Params$Resource$Projects$Locations$Servers$Configureanddeployserver, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        configureAndDeployServer(params?: Params$Resource$Projects$Locations$Servers$Configureanddeployserver, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleLongrunningOperation>>;
        configureAndDeployServer(params: Params$Resource$Projects$Locations$Servers$Configureanddeployserver, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        configureAndDeployServer(params: Params$Resource$Projects$Locations$Servers$Configureanddeployserver, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunningOperation>, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        configureAndDeployServer(params: Params$Resource$Projects$Locations$Servers$Configureanddeployserver, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        configureAndDeployServer(callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
    }
