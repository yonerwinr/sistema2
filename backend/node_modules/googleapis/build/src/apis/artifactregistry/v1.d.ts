...
export declare namespace artifactregistry_v1 {
    ...
    export class Resource$Projects$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getProjectConfig(params: Params$Resource$Projects$Locations$Getprojectconfig, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getProjectConfig(params?: Params$Resource$Projects$Locations$Getprojectconfig, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ProjectConfig>>;
        getProjectConfig(params: Params$Resource$Projects$Locations$Getprojectconfig, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getProjectConfig(params: Params$Resource$Projects$Locations$Getprojectconfig, options: MethodOptions | BodyResponseCallback<Schema$ProjectConfig>, callback: BodyResponseCallback<Schema$ProjectConfig>): void;
        getProjectConfig(params: Params$Resource$Projects$Locations$Getprojectconfig, callback: BodyResponseCallback<Schema$ProjectConfig>): void;
        getProjectConfig(callback: BodyResponseCallback<Schema$ProjectConfig>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateProjectConfig(params: Params$Resource$Projects$Locations$Updateprojectconfig, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        updateProjectConfig(params?: Params$Resource$Projects$Locations$Updateprojectconfig, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ProjectConfig>>;
        updateProjectConfig(params: Params$Resource$Projects$Locations$Updateprojectconfig, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        updateProjectConfig(params: Params$Resource$Projects$Locations$Updateprojectconfig, options: MethodOptions | BodyResponseCallback<Schema$ProjectConfig>, callback: BodyResponseCallback<Schema$ProjectConfig>): void;
        updateProjectConfig(params: Params$Resource$Projects$Locations$Updateprojectconfig, callback: BodyResponseCallback<Schema$ProjectConfig>): void;
        updateProjectConfig(callback: BodyResponseCallback<Schema$ProjectConfig>): void;
        /**
    ...
    export class Resource$Projects$Locations$Repositories {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        checkPrewarmedArtifact(params: Params$Resource$Projects$Locations$Repositories$Checkprewarmedartifact, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        checkPrewarmedArtifact(params?: Params$Resource$Projects$Locations$Repositories$Checkprewarmedartifact, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$CheckPrewarmedArtifactResponse>>;
        checkPrewarmedArtifact(params: Params$Resource$Projects$Locations$Repositories$Checkprewarmedartifact, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        checkPrewarmedArtifact(params: Params$Resource$Projects$Locations$Repositories$Checkprewarmedartifact, options: MethodOptions | BodyResponseCallback<Schema$CheckPrewarmedArtifactResponse>, callback: BodyResponseCallback<Schema$CheckPrewarmedArtifactResponse>): void;
        checkPrewarmedArtifact(params: Params$Resource$Projects$Locations$Repositories$Checkprewarmedartifact, callback: BodyResponseCallback<Schema$CheckPrewarmedArtifactResponse>): void;
        checkPrewarmedArtifact(callback: BodyResponseCallback<Schema$CheckPrewarmedArtifactResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        prewarmArtifact(params: Params$Resource$Projects$Locations$Repositories$Prewarmartifact, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        prewarmArtifact(params?: Params$Resource$Projects$Locations$Repositories$Prewarmartifact, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        prewarmArtifact(params: Params$Resource$Projects$Locations$Repositories$Prewarmartifact, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        prewarmArtifact(params: Params$Resource$Projects$Locations$Repositories$Prewarmartifact, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        prewarmArtifact(params: Params$Resource$Projects$Locations$Repositories$Prewarmartifact, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        removePrewarmedArtifact(params: Params$Resource$Projects$Locations$Repositories$Removeprewarmedartifact, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        removePrewarmedArtifact(params?: Params$Resource$Projects$Locations$Repositories$Removeprewarmedartifact, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$RemovePrewarmedArtifactResponse>>;
        removePrewarmedArtifact(params: Params$Resource$Projects$Locations$Repositories$Removeprewarmedartifact, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        removePrewarmedArtifact(params: Params$Resource$Projects$Locations$Repositories$Removeprewarmedartifact, options: MethodOptions | BodyResponseCallback<Schema$RemovePrewarmedArtifactResponse>, callback: BodyResponseCallback<Schema$RemovePrewarmedArtifactResponse>): void;
        removePrewarmedArtifact(params: Params$Resource$Projects$Locations$Repositories$Removeprewarmedartifact, callback: BodyResponseCallback<Schema$RemovePrewarmedArtifactResponse>): void;
        removePrewarmedArtifact(callback: BodyResponseCallback<Schema$RemovePrewarmedArtifactResponse>): void;
        /**
    ...
    export class Resource$Projects$Locations$Repositories$Prewarmedartifacts {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Repositories$Prewarmedartifacts$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Repositories$Prewarmedartifacts$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListPrewarmedArtifactsResponse>>;
        list(params: Params$Resource$Projects$Locations$Repositories$Prewarmedartifacts$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Repositories$Prewarmedartifacts$List, options: MethodOptions | BodyResponseCallback<Schema$ListPrewarmedArtifactsResponse>, callback: BodyResponseCallback<Schema$ListPrewarmedArtifactsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Repositories$Prewarmedartifacts$List, callback: BodyResponseCallback<Schema$ListPrewarmedArtifactsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListPrewarmedArtifactsResponse>): void;
    }
