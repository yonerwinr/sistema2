...
export declare namespace merchantapi_loyaltycustomers_v1 {
    ...
    export class Resource$Accounts$Loyaltycustomers {
         ...
         */
        manage(params: Params$Resource$Accounts$Loyaltycustomers$Manage, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        manage(params?: Params$Resource$Accounts$Loyaltycustomers$Manage, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ManageLoyaltyCustomerMatchResponse>>;
        manage(params: Params$Resource$Accounts$Loyaltycustomers$Manage, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        manage(params: Params$Resource$Accounts$Loyaltycustomers$Manage, options: MethodOptions | BodyResponseCallback<Schema$ManageLoyaltyCustomerMatchResponse>, callback: BodyResponseCallback<Schema$ManageLoyaltyCustomerMatchResponse>): void;
        manage(params: Params$Resource$Accounts$Loyaltycustomers$Manage, callback: BodyResponseCallback<Schema$ManageLoyaltyCustomerMatchResponse>): void;
        manage(callback: BodyResponseCallback<Schema$ManageLoyaltyCustomerMatchResponse>): void;
    }
