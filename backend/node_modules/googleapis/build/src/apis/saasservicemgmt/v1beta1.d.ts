...
export declare namespace saasservicemgmt_v1beta1 {
    ...
    export class Resource$Projects$Locations$Flagattributes {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Flagattributes$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Flagattributes$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FlagAttribute>>;
        create(params: Params$Resource$Projects$Locations$Flagattributes$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Flagattributes$Create, options: MethodOptions | BodyResponseCallback<Schema$FlagAttribute>, callback: BodyResponseCallback<Schema$FlagAttribute>): void;
        create(params: Params$Resource$Projects$Locations$Flagattributes$Create, callback: BodyResponseCallback<Schema$FlagAttribute>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Flagattributes$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Flagattributes$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Flagattributes$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Flagattributes$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Flagattributes$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Flagattributes$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Flagattributes$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FlagAttribute>>;
        get(params: Params$Resource$Projects$Locations$Flagattributes$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Flagattributes$Get, options: MethodOptions | BodyResponseCallback<Schema$FlagAttribute>, callback: BodyResponseCallback<Schema$FlagAttribute>): void;
        get(params: Params$Resource$Projects$Locations$Flagattributes$Get, callback: BodyResponseCallback<Schema$FlagAttribute>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Flagattributes$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Flagattributes$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListFlagAttributesResponse>>;
        list(params: Params$Resource$Projects$Locations$Flagattributes$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Flagattributes$List, options: MethodOptions | BodyResponseCallback<Schema$ListFlagAttributesResponse>, callback: BodyResponseCallback<Schema$ListFlagAttributesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Flagattributes$List, callback: BodyResponseCallback<Schema$ListFlagAttributesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListFlagAttributesResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Flagattributes$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Flagattributes$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FlagAttribute>>;
        patch(params: Params$Resource$Projects$Locations$Flagattributes$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Flagattributes$Patch, options: MethodOptions | BodyResponseCallback<Schema$FlagAttribute>, callback: BodyResponseCallback<Schema$FlagAttribute>): void;
        patch(params: Params$Resource$Projects$Locations$Flagattributes$Patch, callback: BodyResponseCallback<Schema$FlagAttribute>): void;
    ...
    export class Resource$Projects$Locations$Flagreleases {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Flagreleases$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Flagreleases$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FlagRelease>>;
        create(params: Params$Resource$Projects$Locations$Flagreleases$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Flagreleases$Create, options: MethodOptions | BodyResponseCallback<Schema$FlagRelease>, callback: BodyResponseCallback<Schema$FlagRelease>): void;
        create(params: Params$Resource$Projects$Locations$Flagreleases$Create, callback: BodyResponseCallback<Schema$FlagRelease>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Flagreleases$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Flagreleases$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Flagreleases$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Flagreleases$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Flagreleases$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Flagreleases$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Flagreleases$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FlagRelease>>;
        get(params: Params$Resource$Projects$Locations$Flagreleases$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Flagreleases$Get, options: MethodOptions | BodyResponseCallback<Schema$FlagRelease>, callback: BodyResponseCallback<Schema$FlagRelease>): void;
        get(params: Params$Resource$Projects$Locations$Flagreleases$Get, callback: BodyResponseCallback<Schema$FlagRelease>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Flagreleases$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Flagreleases$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListFlagReleasesResponse>>;
        list(params: Params$Resource$Projects$Locations$Flagreleases$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Flagreleases$List, options: MethodOptions | BodyResponseCallback<Schema$ListFlagReleasesResponse>, callback: BodyResponseCallback<Schema$ListFlagReleasesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Flagreleases$List, callback: BodyResponseCallback<Schema$ListFlagReleasesResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Flagreleases$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Flagreleases$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FlagRelease>>;
        patch(params: Params$Resource$Projects$Locations$Flagreleases$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Flagreleases$Patch, options: MethodOptions | BodyResponseCallback<Schema$FlagRelease>, callback: BodyResponseCallback<Schema$FlagRelease>): void;
        patch(params: Params$Resource$Projects$Locations$Flagreleases$Patch, callback: BodyResponseCallback<Schema$FlagRelease>): void;
    ...
    export class Resource$Projects$Locations$Flagrevisions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Flagrevisions$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Flagrevisions$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FlagRevision>>;
        create(params: Params$Resource$Projects$Locations$Flagrevisions$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Flagrevisions$Create, options: MethodOptions | BodyResponseCallback<Schema$FlagRevision>, callback: BodyResponseCallback<Schema$FlagRevision>): void;
        create(params: Params$Resource$Projects$Locations$Flagrevisions$Create, callback: BodyResponseCallback<Schema$FlagRevision>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Flagrevisions$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Flagrevisions$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Flagrevisions$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Flagrevisions$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Flagrevisions$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Flagrevisions$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Flagrevisions$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FlagRevision>>;
        get(params: Params$Resource$Projects$Locations$Flagrevisions$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Flagrevisions$Get, options: MethodOptions | BodyResponseCallback<Schema$FlagRevision>, callback: BodyResponseCallback<Schema$FlagRevision>): void;
        get(params: Params$Resource$Projects$Locations$Flagrevisions$Get, callback: BodyResponseCallback<Schema$FlagRevision>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Flagrevisions$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Flagrevisions$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListFlagRevisionsResponse>>;
        list(params: Params$Resource$Projects$Locations$Flagrevisions$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Flagrevisions$List, options: MethodOptions | BodyResponseCallback<Schema$ListFlagRevisionsResponse>, callback: BodyResponseCallback<Schema$ListFlagRevisionsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Flagrevisions$List, callback: BodyResponseCallback<Schema$ListFlagRevisionsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListFlagRevisionsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Flagrevisions$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Flagrevisions$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FlagRevision>>;
        patch(params: Params$Resource$Projects$Locations$Flagrevisions$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Flagrevisions$Patch, options: MethodOptions | BodyResponseCallback<Schema$FlagRevision>, callback: BodyResponseCallback<Schema$FlagRevision>): void;
        patch(params: Params$Resource$Projects$Locations$Flagrevisions$Patch, callback: BodyResponseCallback<Schema$FlagRevision>): void;
    ...
    export class Resource$Projects$Locations$Flags {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Flags$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Flags$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Flag>>;
        create(params: Params$Resource$Projects$Locations$Flags$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Flags$Create, options: MethodOptions | BodyResponseCallback<Schema$Flag>, callback: BodyResponseCallback<Schema$Flag>): void;
        create(params: Params$Resource$Projects$Locations$Flags$Create, callback: BodyResponseCallback<Schema$Flag>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Flags$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Flags$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Flags$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Flags$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Flags$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Flags$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Flags$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Flag>>;
        get(params: Params$Resource$Projects$Locations$Flags$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Flags$Get, options: MethodOptions | BodyResponseCallback<Schema$Flag>, callback: BodyResponseCallback<Schema$Flag>): void;
        get(params: Params$Resource$Projects$Locations$Flags$Get, callback: BodyResponseCallback<Schema$Flag>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Flags$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Flags$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListFlagsResponse>>;
        list(params: Params$Resource$Projects$Locations$Flags$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Flags$List, options: MethodOptions | BodyResponseCallback<Schema$ListFlagsResponse>, callback: BodyResponseCallback<Schema$ListFlagsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Flags$List, callback: BodyResponseCallback<Schema$ListFlagsResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Flags$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Flags$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Flag>>;
        patch(params: Params$Resource$Projects$Locations$Flags$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Flags$Patch, options: MethodOptions | BodyResponseCallback<Schema$Flag>, callback: BodyResponseCallback<Schema$Flag>): void;
        patch(params: Params$Resource$Projects$Locations$Flags$Patch, callback: BodyResponseCallback<Schema$Flag>): void;
    ...
    export class Resource$Projects$Locations$Saasreleases {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Saasreleases$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Saasreleases$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SaasRelease>>;
        create(params: Params$Resource$Projects$Locations$Saasreleases$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Saasreleases$Create, options: MethodOptions | BodyResponseCallback<Schema$SaasRelease>, callback: BodyResponseCallback<Schema$SaasRelease>): void;
        create(params: Params$Resource$Projects$Locations$Saasreleases$Create, callback: BodyResponseCallback<Schema$SaasRelease>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Saasreleases$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Saasreleases$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Saasreleases$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Saasreleases$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Saasreleases$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Saasreleases$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Saasreleases$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SaasRelease>>;
        get(params: Params$Resource$Projects$Locations$Saasreleases$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Saasreleases$Get, options: MethodOptions | BodyResponseCallback<Schema$SaasRelease>, callback: BodyResponseCallback<Schema$SaasRelease>): void;
        get(params: Params$Resource$Projects$Locations$Saasreleases$Get, callback: BodyResponseCallback<Schema$SaasRelease>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Saasreleases$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Saasreleases$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListSaasReleasesResponse>>;
        list(params: Params$Resource$Projects$Locations$Saasreleases$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Saasreleases$List, options: MethodOptions | BodyResponseCallback<Schema$ListSaasReleasesResponse>, callback: BodyResponseCallback<Schema$ListSaasReleasesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Saasreleases$List, callback: BodyResponseCallback<Schema$ListSaasReleasesResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Saasreleases$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Saasreleases$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SaasRelease>>;
        patch(params: Params$Resource$Projects$Locations$Saasreleases$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Saasreleases$Patch, options: MethodOptions | BodyResponseCallback<Schema$SaasRelease>, callback: BodyResponseCallback<Schema$SaasRelease>): void;
        patch(params: Params$Resource$Projects$Locations$Saasreleases$Patch, callback: BodyResponseCallback<Schema$SaasRelease>): void;
    ...
    export class Resource$Projects$Locations$Unitgroupoperations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Unitgroupoperations$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Unitgroupoperations$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UnitGroupOperation>>;
        create(params: Params$Resource$Projects$Locations$Unitgroupoperations$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Unitgroupoperations$Create, options: MethodOptions | BodyResponseCallback<Schema$UnitGroupOperation>, callback: BodyResponseCallback<Schema$UnitGroupOperation>): void;
        create(params: Params$Resource$Projects$Locations$Unitgroupoperations$Create, callback: BodyResponseCallback<Schema$UnitGroupOperation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Unitgroupoperations$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Unitgroupoperations$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Unitgroupoperations$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Unitgroupoperations$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Unitgroupoperations$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Unitgroupoperations$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Unitgroupoperations$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UnitGroupOperation>>;
        get(params: Params$Resource$Projects$Locations$Unitgroupoperations$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Unitgroupoperations$Get, options: MethodOptions | BodyResponseCallback<Schema$UnitGroupOperation>, callback: BodyResponseCallback<Schema$UnitGroupOperation>): void;
        get(params: Params$Resource$Projects$Locations$Unitgroupoperations$Get, callback: BodyResponseCallback<Schema$UnitGroupOperation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Unitgroupoperations$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Unitgroupoperations$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListUnitGroupOperationsResponse>>;
        list(params: Params$Resource$Projects$Locations$Unitgroupoperations$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Unitgroupoperations$List, options: MethodOptions | BodyResponseCallback<Schema$ListUnitGroupOperationsResponse>, callback: BodyResponseCallback<Schema$ListUnitGroupOperationsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Unitgroupoperations$List, callback: BodyResponseCallback<Schema$ListUnitGroupOperationsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListUnitGroupOperationsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Unitgroupoperations$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Unitgroupoperations$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UnitGroupOperation>>;
        patch(params: Params$Resource$Projects$Locations$Unitgroupoperations$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Unitgroupoperations$Patch, options: MethodOptions | BodyResponseCallback<Schema$UnitGroupOperation>, callback: BodyResponseCallback<Schema$UnitGroupOperation>): void;
        patch(params: Params$Resource$Projects$Locations$Unitgroupoperations$Patch, callback: BodyResponseCallback<Schema$UnitGroupOperation>): void;
    ...
    export class Resource$Projects$Locations$Unitgroups {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Unitgroups$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Unitgroups$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UnitGroup>>;
        create(params: Params$Resource$Projects$Locations$Unitgroups$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Unitgroups$Create, options: MethodOptions | BodyResponseCallback<Schema$UnitGroup>, callback: BodyResponseCallback<Schema$UnitGroup>): void;
        create(params: Params$Resource$Projects$Locations$Unitgroups$Create, callback: BodyResponseCallback<Schema$UnitGroup>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Unitgroups$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Unitgroups$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Unitgroups$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Unitgroups$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Unitgroups$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Unitgroups$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Unitgroups$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UnitGroup>>;
        get(params: Params$Resource$Projects$Locations$Unitgroups$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Unitgroups$Get, options: MethodOptions | BodyResponseCallback<Schema$UnitGroup>, callback: BodyResponseCallback<Schema$UnitGroup>): void;
        get(params: Params$Resource$Projects$Locations$Unitgroups$Get, callback: BodyResponseCallback<Schema$UnitGroup>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Unitgroups$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Unitgroups$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListUnitGroupsResponse>>;
        list(params: Params$Resource$Projects$Locations$Unitgroups$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Unitgroups$List, options: MethodOptions | BodyResponseCallback<Schema$ListUnitGroupsResponse>, callback: BodyResponseCallback<Schema$ListUnitGroupsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Unitgroups$List, callback: BodyResponseCallback<Schema$ListUnitGroupsResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Unitgroups$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Unitgroups$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UnitGroup>>;
        patch(params: Params$Resource$Projects$Locations$Unitgroups$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Unitgroups$Patch, options: MethodOptions | BodyResponseCallback<Schema$UnitGroup>, callback: BodyResponseCallback<Schema$UnitGroup>): void;
        patch(params: Params$Resource$Projects$Locations$Unitgroups$Patch, callback: BodyResponseCallback<Schema$UnitGroup>): void;
