...
export declare namespace workstations_v1 {
    ...
    export class Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        suspend(params: Params$Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations$Suspend, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        suspend(params?: Params$Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations$Suspend, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        suspend(params: Params$Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations$Suspend, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        suspend(params: Params$Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations$Suspend, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        suspend(params: Params$Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations$Suspend, callback: BodyResponseCallback<Schema$Operation>): void;
