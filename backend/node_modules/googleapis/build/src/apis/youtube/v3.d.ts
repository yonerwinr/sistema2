...
export declare namespace youtube_v3 {
    ...
    export class Resource$Videos {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        batchGetStats(params: Params$Resource$Videos$Batchgetstats, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        batchGetStats(params?: Params$Resource$Videos$Batchgetstats, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BatchGetStatsResponse>>;
        batchGetStats(params: Params$Resource$Videos$Batchgetstats, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        batchGetStats(params: Params$Resource$Videos$Batchgetstats, options: MethodOptions | BodyResponseCallback<Schema$BatchGetStatsResponse>, callback: BodyResponseCallback<Schema$BatchGetStatsResponse>): void;
        batchGetStats(params: Params$Resource$Videos$Batchgetstats, callback: BodyResponseCallback<Schema$BatchGetStatsResponse>): void;
