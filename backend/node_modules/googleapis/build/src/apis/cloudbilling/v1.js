...
(function (cloudbilling_v1) {
    ...
    cloudbilling_v1.Resource$Message = Resource$Message;
    ...
    class Resource$Tasks {
        ...
        constructor(context) {
            this.context = context;
            this.pushNotificationConfigs = new Resource$Tasks$Pushnotificationconfigs(this.context);
        }
    ...
    cloudbilling_v1.Resource$Tasks = Resource$Tasks;
    class Resource$Tasks$Pushnotificationconfigs {
        context;
        constructor(context) {
            this.context = context;
        }
        ...
        list(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/pushNotificationConfigs').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    cloudbilling_v1.Resource$Tasks$Pushnotificationconfigs = Resource$Tasks$Pushnotificationconfigs;
    class Resource$V1 {
        context;
        constructor(context) {
            this.context = context;
    ...
    cloudbilling_v1.Resource$V1 = Resource$V1;
