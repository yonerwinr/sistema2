...
export declare namespace cloudbilling_v1 {
    ...
    export interface Schema$AgentCard {
         ...
         */
        securitySchemes?: {
            [key: string]: Schema$SecurityScheme;
        } | null;
        /**
    ...
    export class Resource$Message {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        send(params: Params$Resource$Message$Send, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        send(params?: Params$Resource$Message$Send, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SendMessageResponse>>;
        send(params: Params$Resource$Message$Send, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        send(params: Params$Resource$Message$Send, options: MethodOptions | BodyResponseCallback<Schema$SendMessageResponse>, callback: BodyResponseCallback<Schema$SendMessageResponse>): void;
        send(params: Params$Resource$Message$Send, callback: BodyResponseCallback<Schema$SendMessageResponse>): void;
    ...
    export class Resource$V1 {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getCard(params: Params$Resource$V1$Getcard, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getCard(params?: Params$Resource$V1$Getcard, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AgentCard>>;
        getCard(params: Params$Resource$V1$Getcard, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getCard(params: Params$Resource$V1$Getcard, options: MethodOptions | BodyResponseCallback<Schema$AgentCard>, callback: BodyResponseCallback<Schema$AgentCard>): void;
        getCard(params: Params$Resource$V1$Getcard, callback: BodyResponseCallback<Schema$AgentCard>): void;
