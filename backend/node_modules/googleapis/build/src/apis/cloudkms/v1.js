...
(function (cloudkms_v1) {
    ...
    class Resource$Projects$Locations {
        ...
        constructor(context) {
            ...
            this.retiredResources = new Resource$Projects$Locations$Retiredresources(this.context);
    ...
    class Resource$Projects$Locations$Keyrings$Cryptokeys$Cryptokeyversions {
        ...
        exportTrustedKeyWrappedCryptoKeyVersion(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:exportTrustedKeyWrappedCryptoKeyVersion').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
        ...
        importTrustedKeyWrappedCryptoKeyVersion(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v1/{+parent}/cryptoKeyVersions:importTrustedKeyWrappedCryptoKeyVersion').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    class Resource$Projects$Locations$Retiredresources {
        context;
        constructor(context) {
            this.context = context;
        }
        ...
        list(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/retiredResources').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    cloudkms_v1.Resource$Projects$Locations$Retiredresources = Resource$Projects$Locations$Retiredresources;
    class Resource$Projects$Locations$Singletenanthsminstances {
        context;
        proposals;
        constructor(context) {
            this.context = context;
            this.proposals =
                new Resource$Projects$Locations$Singletenanthsminstances$Proposals(this.context);
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/singleTenantHsmInstances').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    cloudkms_v1.Resource$Projects$Locations$Singletenanthsminstances = Resource$Projects$Locations$Singletenanthsminstances;
    class Resource$Projects$Locations$Singletenanthsminstances$Proposals {
        context;
        constructor(context) {
            this.context = context;
        }
        ...
        execute(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:execute').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    cloudkms_v1.Resource$Projects$Locations$Singletenanthsminstances$Proposals = Resource$Projects$Locations$Singletenanthsminstances$Proposals;
