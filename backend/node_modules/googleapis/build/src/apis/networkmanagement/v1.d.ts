...
export declare namespace networkmanagement_v1 {
    ...
    export class Resource$Projects$Locations$Networkmonitoringproviders {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generateMonitoringPointConfig(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Generatemonitoringpointconfig, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        generateMonitoringPointConfig(params?: Params$Resource$Projects$Locations$Networkmonitoringproviders$Generatemonitoringpointconfig, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GenerateMonitoringPointConfigResponse>>;
        generateMonitoringPointConfig(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Generatemonitoringpointconfig, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        generateMonitoringPointConfig(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Generatemonitoringpointconfig, options: MethodOptions | BodyResponseCallback<Schema$GenerateMonitoringPointConfigResponse>, callback: BodyResponseCallback<Schema$GenerateMonitoringPointConfigResponse>): void;
        generateMonitoringPointConfig(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Generatemonitoringpointconfig, callback: BodyResponseCallback<Schema$GenerateMonitoringPointConfigResponse>): void;
        generateMonitoringPointConfig(callback: BodyResponseCallback<Schema$GenerateMonitoringPointConfigResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generateProviderAccessToken(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Generateprovideraccesstoken, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        generateProviderAccessToken(params?: Params$Resource$Projects$Locations$Networkmonitoringproviders$Generateprovideraccesstoken, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GenerateProviderAccessTokenResponse>>;
        generateProviderAccessToken(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Generateprovideraccesstoken, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        generateProviderAccessToken(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Generateprovideraccesstoken, options: MethodOptions | BodyResponseCallback<Schema$GenerateProviderAccessTokenResponse>, callback: BodyResponseCallback<Schema$GenerateProviderAccessTokenResponse>): void;
        generateProviderAccessToken(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Generateprovideraccesstoken, callback: BodyResponseCallback<Schema$GenerateProviderAccessTokenResponse>): void;
        generateProviderAccessToken(callback: BodyResponseCallback<Schema$GenerateProviderAccessTokenResponse>): void;
        /**
    ...
    export class Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        downloadInstallScript(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadinstallscript, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        downloadInstallScript(params?: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadinstallscript, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$HttpBody>>;
        downloadInstallScript(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadinstallscript, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        downloadInstallScript(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadinstallscript, options: MethodOptions | BodyResponseCallback<Schema$HttpBody>, callback: BodyResponseCallback<Schema$HttpBody>): void;
        downloadInstallScript(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadinstallscript, callback: BodyResponseCallback<Schema$HttpBody>): void;
        downloadInstallScript(callback: BodyResponseCallback<Schema$HttpBody>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        downloadRecreateInstallScript(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadrecreateinstallscript, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        downloadRecreateInstallScript(params?: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadrecreateinstallscript, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$HttpBody>>;
        downloadRecreateInstallScript(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadrecreateinstallscript, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        downloadRecreateInstallScript(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadrecreateinstallscript, options: MethodOptions | BodyResponseCallback<Schema$HttpBody>, callback: BodyResponseCallback<Schema$HttpBody>): void;
        downloadRecreateInstallScript(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadrecreateinstallscript, callback: BodyResponseCallback<Schema$HttpBody>): void;
        downloadRecreateInstallScript(callback: BodyResponseCallback<Schema$HttpBody>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        downloadServerConnectConfig(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadserverconnectconfig, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        downloadServerConnectConfig(params?: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadserverconnectconfig, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$HttpBody>>;
        downloadServerConnectConfig(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadserverconnectconfig, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        downloadServerConnectConfig(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadserverconnectconfig, options: MethodOptions | BodyResponseCallback<Schema$HttpBody>, callback: BodyResponseCallback<Schema$HttpBody>): void;
        downloadServerConnectConfig(params: Params$Resource$Projects$Locations$Networkmonitoringproviders$Monitoringpoints$Downloadserverconnectconfig, callback: BodyResponseCallback<Schema$HttpBody>): void;
        downloadServerConnectConfig(callback: BodyResponseCallback<Schema$HttpBody>): void;
        /**
