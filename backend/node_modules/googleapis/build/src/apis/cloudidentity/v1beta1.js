...
(function (cloudidentity_v1beta1) {
    ...
    class Resource$Allowlisteddomains {
        context;
        constructor(context) {
        ...
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1beta1/allowlistedDomains').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    cloudidentity_v1beta1.Resource$Allowlisteddomains = Resource$Allowlisteddomains;
