...
export declare namespace cloudidentity_v1 {
    ...
    export class Resource$Allowlisteddomains {
         ...
         */
        create(params: Params$Resource$Allowlisteddomains$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Allowlisteddomains$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        create(params: Params$Resource$Allowlisteddomains$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Allowlisteddomains$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Allowlisteddomains$Create, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Allowlisteddomains$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Allowlisteddomains$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Allowlisteddomains$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Allowlisteddomains$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Allowlisteddomains$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Allowlisteddomains$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Allowlisteddomains$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AllowlistedDomain>>;
        get(params: Params$Resource$Allowlisteddomains$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Allowlisteddomains$Get, options: MethodOptions | BodyResponseCallback<Schema$AllowlistedDomain>, callback: BodyResponseCallback<Schema$AllowlistedDomain>): void;
        get(params: Params$Resource$Allowlisteddomains$Get, callback: BodyResponseCallback<Schema$AllowlistedDomain>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Allowlisteddomains$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Allowlisteddomains$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListAllowlistedDomainsResponse>>;
        list(params: Params$Resource$Allowlisteddomains$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Allowlisteddomains$List, options: MethodOptions | BodyResponseCallback<Schema$ListAllowlistedDomainsResponse>, callback: BodyResponseCallback<Schema$ListAllowlistedDomainsResponse>): void;
        list(params: Params$Resource$Allowlisteddomains$List, callback: BodyResponseCallback<Schema$ListAllowlistedDomainsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListAllowlistedDomainsResponse>): void;
    }
