...
export declare namespace iam_v1 {
    ...
    export class Resource$Locations$Workforcepools$Providers$Scimtenants {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getIamPolicy(params: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Getiampolicy, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getIamPolicy(params?: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Getiampolicy, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Policy>>;
        getIamPolicy(params: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Getiampolicy, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getIamPolicy(params: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Getiampolicy, options: MethodOptions | BodyResponseCallback<Schema$Policy>, callback: BodyResponseCallback<Schema$Policy>): void;
        getIamPolicy(params: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Getiampolicy, callback: BodyResponseCallback<Schema$Policy>): void;
        getIamPolicy(callback: BodyResponseCallback<Schema$Policy>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        setIamPolicy(params: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Setiampolicy, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        setIamPolicy(params?: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Setiampolicy, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Policy>>;
        setIamPolicy(params: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Setiampolicy, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        setIamPolicy(params: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Setiampolicy, options: MethodOptions | BodyResponseCallback<Schema$Policy>, callback: BodyResponseCallback<Schema$Policy>): void;
        setIamPolicy(params: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Setiampolicy, callback: BodyResponseCallback<Schema$Policy>): void;
        setIamPolicy(callback: BodyResponseCallback<Schema$Policy>): void;
        /**
         * Returns the caller's permissions on the WorkforcePool. If the pool doesn't exist, this call returns an empty set of permissions. It doesn't return a `NOT_FOUND` error.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        testIamPermissions(params: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Testiampermissions, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        testIamPermissions(params?: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Testiampermissions, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TestIamPermissionsResponse>>;
        testIamPermissions(params: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Testiampermissions, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        testIamPermissions(params: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Testiampermissions, options: MethodOptions | BodyResponseCallback<Schema$TestIamPermissionsResponse>, callback: BodyResponseCallback<Schema$TestIamPermissionsResponse>): void;
        testIamPermissions(params: Params$Resource$Locations$Workforcepools$Providers$Scimtenants$Testiampermissions, callback: BodyResponseCallback<Schema$TestIamPermissionsResponse>): void;
        testIamPermissions(callback: BodyResponseCallback<Schema$TestIamPermissionsResponse>): void;
        /**
    ...
    export class Resource$Projects$Locations$Workloadidentitypools {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        addAttestationRule(params: Params$Resource$Projects$Locations$Workloadidentitypools$Addattestationrule, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        addAttestationRule(params?: Params$Resource$Projects$Locations$Workloadidentitypools$Addattestationrule, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        addAttestationRule(params: Params$Resource$Projects$Locations$Workloadidentitypools$Addattestationrule, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        addAttestationRule(params: Params$Resource$Projects$Locations$Workloadidentitypools$Addattestationrule, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        addAttestationRule(params: Params$Resource$Projects$Locations$Workloadidentitypools$Addattestationrule, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        listAttestationRules(params: Params$Resource$Projects$Locations$Workloadidentitypools$Listattestationrules, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        listAttestationRules(params?: Params$Resource$Projects$Locations$Workloadidentitypools$Listattestationrules, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListAttestationRulesResponse>>;
        listAttestationRules(params: Params$Resource$Projects$Locations$Workloadidentitypools$Listattestationrules, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        listAttestationRules(params: Params$Resource$Projects$Locations$Workloadidentitypools$Listattestationrules, options: MethodOptions | BodyResponseCallback<Schema$ListAttestationRulesResponse>, callback: BodyResponseCallback<Schema$ListAttestationRulesResponse>): void;
        listAttestationRules(params: Params$Resource$Projects$Locations$Workloadidentitypools$Listattestationrules, callback: BodyResponseCallback<Schema$ListAttestationRulesResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        removeAttestationRule(params: Params$Resource$Projects$Locations$Workloadidentitypools$Removeattestationrule, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        removeAttestationRule(params?: Params$Resource$Projects$Locations$Workloadidentitypools$Removeattestationrule, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        removeAttestationRule(params: Params$Resource$Projects$Locations$Workloadidentitypools$Removeattestationrule, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        removeAttestationRule(params: Params$Resource$Projects$Locations$Workloadidentitypools$Removeattestationrule, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        removeAttestationRule(params: Params$Resource$Projects$Locations$Workloadidentitypools$Removeattestationrule, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        setAttestationRules(params: Params$Resource$Projects$Locations$Workloadidentitypools$Setattestationrules, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        setAttestationRules(params?: Params$Resource$Projects$Locations$Workloadidentitypools$Setattestationrules, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        setAttestationRules(params: Params$Resource$Projects$Locations$Workloadidentitypools$Setattestationrules, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        setAttestationRules(params: Params$Resource$Projects$Locations$Workloadidentitypools$Setattestationrules, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        setAttestationRules(params: Params$Resource$Projects$Locations$Workloadidentitypools$Setattestationrules, callback: BodyResponseCallback<Schema$Operation>): void;
