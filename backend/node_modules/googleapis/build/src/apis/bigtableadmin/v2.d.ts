...
export declare namespace bigtableadmin_v2 {
    ...
    export class Resource$Projects$Instances$Clusters {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateMemoryLayer(params: Params$Resource$Projects$Instances$Clusters$Updatememorylayer, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        updateMemoryLayer(params?: Params$Resource$Projects$Instances$Clusters$Updatememorylayer, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        updateMemoryLayer(params: Params$Resource$Projects$Instances$Clusters$Updatememorylayer, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        updateMemoryLayer(params: Params$Resource$Projects$Instances$Clusters$Updatememorylayer, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        updateMemoryLayer(params: Params$Resource$Projects$Instances$Clusters$Updatememorylayer, callback: BodyResponseCallback<Schema$Operation>): void;
