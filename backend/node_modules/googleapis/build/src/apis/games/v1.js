...
(function (games_v1) {
    ...
    class Resource$Gamestats {
        context;
        constructor(context) {
            this.context = context;
        }
        batchRecordEvents(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/games/v1/players/{playerId}/gameStats:batchRecordEvents').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    games_v1.Resource$Gamestats = Resource$Gamestats;
