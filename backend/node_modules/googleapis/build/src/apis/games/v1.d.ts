...
export declare namespace games_v1 {
    ...
    export interface Schema$AchievementDefinition {
         ...
         */
        achievementLifecycleState?: string | null;
        /**
     ...
     */
    export interface Schema$BatchRecordEventsResponse {
        /**
     ...
     */
    export interface Schema$PlayerGameEvent {
        /**
         ...
         */
        eventProperties?: {
            [key: string]: Schema$PropertyValue;
        } | null;
        /**
    ...
    export class Resource$Gamestats {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        batchRecordEvents(params: Params$Resource$Gamestats$Batchrecordevents, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        batchRecordEvents(params?: Params$Resource$Gamestats$Batchrecordevents, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BatchRecordEventsResponse>>;
        batchRecordEvents(params: Params$Resource$Gamestats$Batchrecordevents, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        batchRecordEvents(params: Params$Resource$Gamestats$Batchrecordevents, options: MethodOptions | BodyResponseCallback<Schema$BatchRecordEventsResponse>, callback: BodyResponseCallback<Schema$BatchRecordEventsResponse>): void;
        batchRecordEvents(params: Params$Resource$Gamestats$Batchrecordevents, callback: BodyResponseCallback<Schema$BatchRecordEventsResponse>): void;
        batchRecordEvents(callback: BodyResponseCallback<Schema$BatchRecordEventsResponse>): void;
    }
