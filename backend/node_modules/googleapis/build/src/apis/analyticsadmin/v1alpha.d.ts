...
export declare namespace analyticsadmin_v1alpha {
    ...
    export interface Schema$GoogleAnalyticsAdminV1alphaChangeHistoryChangeChangeHistoryResource {
         ...
         */
        userProvidedDataSettings?: Schema$GoogleAnalyticsAdminV1alphaUserProvidedDataSettings;
    }
    /**
     ...
     */
    export interface Schema$GoogleAnalyticsAdminV1alphaUserProvidedDataSettings {
        /**
    ...
    export class Resource$Properties {
         ...
         *
         *   // Do the magic
         *   const res = await analyticsadmin.properties.getUserProvidedDataSettings({
         *     // Required. The name of the user provided data settings to retrieve. Format: properties/{property\}/userProvidedDataSettings
         *     name: 'properties/my-propertie/userProvidedDataSettings',
         *   });
         *   console.log(res.data);
         *
         *   // Example response
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getUserProvidedDataSettings(params: Params$Resource$Properties$Getuserprovideddatasettings, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getUserProvidedDataSettings(params?: Params$Resource$Properties$Getuserprovideddatasettings, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleAnalyticsAdminV1alphaUserProvidedDataSettings>>;
        getUserProvidedDataSettings(params: Params$Resource$Properties$Getuserprovideddatasettings, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getUserProvidedDataSettings(params: Params$Resource$Properties$Getuserprovideddatasettings, options: MethodOptions | BodyResponseCallback<Schema$GoogleAnalyticsAdminV1alphaUserProvidedDataSettings>, callback: BodyResponseCallback<Schema$GoogleAnalyticsAdminV1alphaUserProvidedDataSettings>): void;
        getUserProvidedDataSettings(params: Params$Resource$Properties$Getuserprovideddatasettings, callback: BodyResponseCallback<Schema$GoogleAnalyticsAdminV1alphaUserProvidedDataSettings>): void;
        getUserProvidedDataSettings(callback: BodyResponseCallback<Schema$GoogleAnalyticsAdminV1alphaUserProvidedDataSettings>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateReportingIdentitySettings(params: Params$Resource$Properties$Updatereportingidentitysettings, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        updateReportingIdentitySettings(params?: Params$Resource$Properties$Updatereportingidentitysettings, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleAnalyticsAdminV1alphaReportingIdentitySettings>>;
        updateReportingIdentitySettings(params: Params$Resource$Properties$Updatereportingidentitysettings, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        updateReportingIdentitySettings(params: Params$Resource$Properties$Updatereportingidentitysettings, options: MethodOptions | BodyResponseCallback<Schema$GoogleAnalyticsAdminV1alphaReportingIdentitySettings>, callback: BodyResponseCallback<Schema$GoogleAnalyticsAdminV1alphaReportingIdentitySettings>): void;
        updateReportingIdentitySettings(params: Params$Resource$Properties$Updatereportingidentitysettings, callback: BodyResponseCallback<Schema$GoogleAnalyticsAdminV1alphaReportingIdentitySettings>): void;
        updateReportingIdentitySettings(callback: BodyResponseCallback<Schema$GoogleAnalyticsAdminV1alphaReportingIdentitySettings>): void;
    }
    ...
    export interface Params$Resource$Properties$Getuserprovideddatasettings extends StandardParameters {
        /**
         * Required. The name of the user provided data settings to retrieve. Format: properties/{property\}/userProvidedDataSettings
         */
        name?: string;
