...
export declare namespace composer_v1beta1 {
    ...
    export class Resource$Projects$Locations$Environments {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        hibernate(params: Params$Resource$Projects$Locations$Environments$Hibernate, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        hibernate(params?: Params$Resource$Projects$Locations$Environments$Hibernate, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        hibernate(params: Params$Resource$Projects$Locations$Environments$Hibernate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        hibernate(params: Params$Resource$Projects$Locations$Environments$Hibernate, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        hibernate(params: Params$Resource$Projects$Locations$Environments$Hibernate, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        resume(params: Params$Resource$Projects$Locations$Environments$Resume, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        resume(params?: Params$Resource$Projects$Locations$Environments$Resume, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        resume(params: Params$Resource$Projects$Locations$Environments$Resume, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        resume(params: Params$Resource$Projects$Locations$Environments$Resume, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        resume(params: Params$Resource$Projects$Locations$Environments$Resume, callback: BodyResponseCallback<Schema$Operation>): void;
