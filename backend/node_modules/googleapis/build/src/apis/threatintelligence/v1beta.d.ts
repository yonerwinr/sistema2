...
export declare namespace threatintelligence_v1beta {
    ...
    export class Resource$Projects$Alerts {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getPassword(params: Params$Resource$Projects$Alerts$Getpassword, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getPassword(params?: Params$Resource$Projects$Alerts$Getpassword, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GetPasswordResponse>>;
        getPassword(params: Params$Resource$Projects$Alerts$Getpassword, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getPassword(params: Params$Resource$Projects$Alerts$Getpassword, options: MethodOptions | BodyResponseCallback<Schema$GetPasswordResponse>, callback: BodyResponseCallback<Schema$GetPasswordResponse>): void;
        getPassword(params: Params$Resource$Projects$Alerts$Getpassword, callback: BodyResponseCallback<Schema$GetPasswordResponse>): void;
        getPassword(callback: BodyResponseCallback<Schema$GetPasswordResponse>): void;
        /**
