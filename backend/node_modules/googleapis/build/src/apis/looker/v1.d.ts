...
export declare namespace looker_v1 {
    ...
    export class Resource$Projects$Locations$Instances {
        ...
        undelete(params?: Params$Resource$Projects$Locations$Instances$Undelete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        ...
        undelete(params: Params$Resource$Projects$Locations$Instances$Undelete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        undelete(params: Params$Resource$Projects$Locations$Instances$Undelete, callback: BodyResponseCallback<Schema$Operation>): void;
