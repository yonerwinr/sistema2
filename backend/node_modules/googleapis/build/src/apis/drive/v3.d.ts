...
export declare namespace drive_v3 {
    ...
    export class Resource$Approvals {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        approve(params: Params$Resource$Approvals$Approve, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        approve(params?: Params$Resource$Approvals$Approve, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Approval>>;
        approve(params: Params$Resource$Approvals$Approve, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        approve(params: Params$Resource$Approvals$Approve, options: MethodOptions | BodyResponseCallback<Schema$Approval>, callback: BodyResponseCallback<Schema$Approval>): void;
        approve(params: Params$Resource$Approvals$Approve, callback: BodyResponseCallback<Schema$Approval>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        cancel(params: Params$Resource$Approvals$Cancel, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        cancel(params?: Params$Resource$Approvals$Cancel, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Approval>>;
        cancel(params: Params$Resource$Approvals$Cancel, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        cancel(params: Params$Resource$Approvals$Cancel, options: MethodOptions | BodyResponseCallback<Schema$Approval>, callback: BodyResponseCallback<Schema$Approval>): void;
        cancel(params: Params$Resource$Approvals$Cancel, callback: BodyResponseCallback<Schema$Approval>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        comment(params: Params$Resource$Approvals$Comment, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        comment(params?: Params$Resource$Approvals$Comment, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Approval>>;
        comment(params: Params$Resource$Approvals$Comment, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        comment(params: Params$Resource$Approvals$Comment, options: MethodOptions | BodyResponseCallback<Schema$Approval>, callback: BodyResponseCallback<Schema$Approval>): void;
        comment(params: Params$Resource$Approvals$Comment, callback: BodyResponseCallback<Schema$Approval>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        decline(params: Params$Resource$Approvals$Decline, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        decline(params?: Params$Resource$Approvals$Decline, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Approval>>;
        decline(params: Params$Resource$Approvals$Decline, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        decline(params: Params$Resource$Approvals$Decline, options: MethodOptions | BodyResponseCallback<Schema$Approval>, callback: BodyResponseCallback<Schema$Approval>): void;
        decline(params: Params$Resource$Approvals$Decline, callback: BodyResponseCallback<Schema$Approval>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        reassign(params: Params$Resource$Approvals$Reassign, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        reassign(params?: Params$Resource$Approvals$Reassign, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Approval>>;
        reassign(params: Params$Resource$Approvals$Reassign, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        reassign(params: Params$Resource$Approvals$Reassign, options: MethodOptions | BodyResponseCallback<Schema$Approval>, callback: BodyResponseCallback<Schema$Approval>): void;
        reassign(params: Params$Resource$Approvals$Reassign, callback: BodyResponseCallback<Schema$Approval>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        start(params: Params$Resource$Approvals$Start, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        start(params?: Params$Resource$Approvals$Start, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Approval>>;
        start(params: Params$Resource$Approvals$Start, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        start(params: Params$Resource$Approvals$Start, options: MethodOptions | BodyResponseCallback<Schema$Approval>, callback: BodyResponseCallback<Schema$Approval>): void;
        start(params: Params$Resource$Approvals$Start, callback: BodyResponseCallback<Schema$Approval>): void;
    ...
    export class Resource$Files {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generateCseToken(params: Params$Resource$Files$Generatecsetoken, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        generateCseToken(params?: Params$Resource$Files$Generatecsetoken, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GenerateCseTokenResponse>>;
        generateCseToken(params: Params$Resource$Files$Generatecsetoken, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        generateCseToken(params: Params$Resource$Files$Generatecsetoken, options: MethodOptions | BodyResponseCallback<Schema$GenerateCseTokenResponse>, callback: BodyResponseCallback<Schema$GenerateCseTokenResponse>): void;
        generateCseToken(params: Params$Resource$Files$Generatecsetoken, callback: BodyResponseCallback<Schema$GenerateCseTokenResponse>): void;
        generateCseToken(callback: BodyResponseCallback<Schema$GenerateCseTokenResponse>): void;
        /**
