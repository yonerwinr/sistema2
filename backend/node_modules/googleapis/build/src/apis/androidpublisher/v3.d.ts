...
export declare namespace androidpublisher_v3 {
    ...
    export class Resource$Appsigning {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        enrollApp(params: Params$Resource$Appsigning$Enrollapp, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        enrollApp(params?: Params$Resource$Appsigning$Enrollapp, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$EnrollAppResponse>>;
        enrollApp(params: Params$Resource$Appsigning$Enrollapp, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        enrollApp(params: Params$Resource$Appsigning$Enrollapp, options: MethodOptions | BodyResponseCallback<Schema$EnrollAppResponse>, callback: BodyResponseCallback<Schema$EnrollAppResponse>): void;
        enrollApp(params: Params$Resource$Appsigning$Enrollapp, callback: BodyResponseCallback<Schema$EnrollAppResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        rotateAppSigningKey(params: Params$Resource$Appsigning$Rotateappsigningkey, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        rotateAppSigningKey(params?: Params$Resource$Appsigning$Rotateappsigningkey, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$RotateAppSigningKeyResponse>>;
        rotateAppSigningKey(params: Params$Resource$Appsigning$Rotateappsigningkey, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        rotateAppSigningKey(params: Params$Resource$Appsigning$Rotateappsigningkey, options: MethodOptions | BodyResponseCallback<Schema$RotateAppSigningKeyResponse>, callback: BodyResponseCallback<Schema$RotateAppSigningKeyResponse>): void;
        rotateAppSigningKey(params: Params$Resource$Appsigning$Rotateappsigningkey, callback: BodyResponseCallback<Schema$RotateAppSigningKeyResponse>): void;
        rotateAppSigningKey(callback: BodyResponseCallback<Schema$RotateAppSigningKeyResponse>): void;
    }
    ...
    export class Resource$Appstoreappsreview {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        createappstorehostedapp(params: Params$Resource$Appstoreappsreview$Createappstorehostedapp, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        createappstorehostedapp(params?: Params$Resource$Appstoreappsreview$Createappstorehostedapp, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$CreateAppStoreHostedAppResponse>>;
        createappstorehostedapp(params: Params$Resource$Appstoreappsreview$Createappstorehostedapp, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        createappstorehostedapp(params: Params$Resource$Appstoreappsreview$Createappstorehostedapp, options: MethodOptions | BodyResponseCallback<Schema$CreateAppStoreHostedAppResponse>, callback: BodyResponseCallback<Schema$CreateAppStoreHostedAppResponse>): void;
        createappstorehostedapp(params: Params$Resource$Appstoreappsreview$Createappstorehostedapp, callback: BodyResponseCallback<Schema$CreateAppStoreHostedAppResponse>): void;
        createappstorehostedapp(callback: BodyResponseCallback<Schema$CreateAppStoreHostedAppResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateappstorehostedapp(params: Params$Resource$Appstoreappsreview$Updateappstorehostedapp, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        updateappstorehostedapp(params?: Params$Resource$Appstoreappsreview$Updateappstorehostedapp, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UpdateAppStoreHostedAppResponse>>;
        updateappstorehostedapp(params: Params$Resource$Appstoreappsreview$Updateappstorehostedapp, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        updateappstorehostedapp(params: Params$Resource$Appstoreappsreview$Updateappstorehostedapp, options: MethodOptions | BodyResponseCallback<Schema$UpdateAppStoreHostedAppResponse>, callback: BodyResponseCallback<Schema$UpdateAppStoreHostedAppResponse>): void;
        updateappstorehostedapp(params: Params$Resource$Appstoreappsreview$Updateappstorehostedapp, callback: BodyResponseCallback<Schema$UpdateAppStoreHostedAppResponse>): void;
        updateappstorehostedapp(callback: BodyResponseCallback<Schema$UpdateAppStoreHostedAppResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateappstorehostedapppublishstatus(params: Params$Resource$Appstoreappsreview$Updateappstorehostedapppublishstatus, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        updateappstorehostedapppublishstatus(params?: Params$Resource$Appstoreappsreview$Updateappstorehostedapppublishstatus, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UpdateAppStoreHostedAppPublishStatusResponse>>;
        updateappstorehostedapppublishstatus(params: Params$Resource$Appstoreappsreview$Updateappstorehostedapppublishstatus, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        updateappstorehostedapppublishstatus(params: Params$Resource$Appstoreappsreview$Updateappstorehostedapppublishstatus, options: MethodOptions | BodyResponseCallback<Schema$UpdateAppStoreHostedAppPublishStatusResponse>, callback: BodyResponseCallback<Schema$UpdateAppStoreHostedAppPublishStatusResponse>): void;
        updateappstorehostedapppublishstatus(params: Params$Resource$Appstoreappsreview$Updateappstorehostedapppublishstatus, callback: BodyResponseCallback<Schema$UpdateAppStoreHostedAppPublishStatusResponse>): void;
        updateappstorehostedapppublishstatus(callback: BodyResponseCallback<Schema$UpdateAppStoreHostedAppPublishStatusResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        uploadapk(params: Params$Resource$Appstoreappsreview$Uploadapk, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        uploadapk(params?: Params$Resource$Appstoreappsreview$Uploadapk, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UploadApkResponse>>;
        uploadapk(params: Params$Resource$Appstoreappsreview$Uploadapk, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        uploadapk(params: Params$Resource$Appstoreappsreview$Uploadapk, options: MethodOptions | BodyResponseCallback<Schema$UploadApkResponse>, callback: BodyResponseCallback<Schema$UploadApkResponse>): void;
        uploadapk(params: Params$Resource$Appstoreappsreview$Uploadapk, callback: BodyResponseCallback<Schema$UploadApkResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        uploadappstoreapppolicydeclarationfile(params: Params$Resource$Appstoreappsreview$Uploadappstoreapppolicydeclarationfile, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        uploadappstoreapppolicydeclarationfile(params?: Params$Resource$Appstoreappsreview$Uploadappstoreapppolicydeclarationfile, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UploadAppStoreAppPolicyDeclarationFileResponse>>;
        uploadappstoreapppolicydeclarationfile(params: Params$Resource$Appstoreappsreview$Uploadappstoreapppolicydeclarationfile, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        uploadappstoreapppolicydeclarationfile(params: Params$Resource$Appstoreappsreview$Uploadappstoreapppolicydeclarationfile, options: MethodOptions | BodyResponseCallback<Schema$UploadAppStoreAppPolicyDeclarationFileResponse>, callback: BodyResponseCallback<Schema$UploadAppStoreAppPolicyDeclarationFileResponse>): void;
        uploadappstoreapppolicydeclarationfile(params: Params$Resource$Appstoreappsreview$Uploadappstoreapppolicydeclarationfile, callback: BodyResponseCallback<Schema$UploadAppStoreAppPolicyDeclarationFileResponse>): void;
        uploadappstoreapppolicydeclarationfile(callback: BodyResponseCallback<Schema$UploadAppStoreAppPolicyDeclarationFileResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        uploadimage(params: Params$Resource$Appstoreappsreview$Uploadimage, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        uploadimage(params?: Params$Resource$Appstoreappsreview$Uploadimage, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UploadImageResponse>>;
        uploadimage(params: Params$Resource$Appstoreappsreview$Uploadimage, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        uploadimage(params: Params$Resource$Appstoreappsreview$Uploadimage, options: MethodOptions | BodyResponseCallback<Schema$UploadImageResponse>, callback: BodyResponseCallback<Schema$UploadImageResponse>): void;
        uploadimage(params: Params$Resource$Appstoreappsreview$Uploadimage, callback: BodyResponseCallback<Schema$UploadImageResponse>): void;
        uploadimage(callback: BodyResponseCallback<Schema$UploadImageResponse>): void;
    }
    ...
    export class Resource$Appstorecatalog$Recentappviews {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Appstorecatalog$Recentappviews$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Appstorecatalog$Recentappviews$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$RecentAppView>>;
        get(params: Params$Resource$Appstorecatalog$Recentappviews$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Appstorecatalog$Recentappviews$Get, options: MethodOptions | BodyResponseCallback<Schema$RecentAppView>, callback: BodyResponseCallback<Schema$RecentAppView>): void;
        get(params: Params$Resource$Appstorecatalog$Recentappviews$Get, callback: BodyResponseCallback<Schema$RecentAppView>): void;
    ...
    export class Resource$Appstorecatalog$Recentupdateevents {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Appstorecatalog$Recentupdateevents$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Appstorecatalog$Recentupdateevents$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListRecentUpdateEventsResponse>>;
        list(params: Params$Resource$Appstorecatalog$Recentupdateevents$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Appstorecatalog$Recentupdateevents$List, options: MethodOptions | BodyResponseCallback<Schema$ListRecentUpdateEventsResponse>, callback: BodyResponseCallback<Schema$ListRecentUpdateEventsResponse>): void;
        list(params: Params$Resource$Appstorecatalog$Recentupdateevents$List, callback: BodyResponseCallback<Schema$ListRecentUpdateEventsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListRecentUpdateEventsResponse>): void;
    }
    ...
    export class Resource$Orders {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        reviewrefund(params: Params$Resource$Orders$Reviewrefund, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        reviewrefund(params?: Params$Resource$Orders$Reviewrefund, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<void>>;
        reviewrefund(params: Params$Resource$Orders$Reviewrefund, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        reviewrefund(params: Params$Resource$Orders$Reviewrefund, options: MethodOptions | BodyResponseCallback<void>, callback: BodyResponseCallback<void>): void;
        reviewrefund(params: Params$Resource$Orders$Reviewrefund, callback: BodyResponseCallback<void>): void;
