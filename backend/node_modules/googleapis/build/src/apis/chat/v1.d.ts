...
export declare namespace chat_v1 {
    ...
    export class Resource$Spaces$Messagepins {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Spaces$Messagepins$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Spaces$Messagepins$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$MessagePin>>;
        create(params: Params$Resource$Spaces$Messagepins$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Spaces$Messagepins$Create, options: MethodOptions | BodyResponseCallback<Schema$MessagePin>, callback: BodyResponseCallback<Schema$MessagePin>): void;
        create(params: Params$Resource$Spaces$Messagepins$Create, callback: BodyResponseCallback<Schema$MessagePin>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Spaces$Messagepins$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Spaces$Messagepins$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Spaces$Messagepins$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Spaces$Messagepins$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Spaces$Messagepins$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Spaces$Messagepins$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Spaces$Messagepins$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListMessagePinsResponse>>;
        list(params: Params$Resource$Spaces$Messagepins$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Spaces$Messagepins$List, options: MethodOptions | BodyResponseCallback<Schema$ListMessagePinsResponse>, callback: BodyResponseCallback<Schema$ListMessagePinsResponse>): void;
        list(params: Params$Resource$Spaces$Messagepins$List, callback: BodyResponseCallback<Schema$ListMessagePinsResponse>): void;
    ...
    export class Resource$Spaces$Messages {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        search(params: Params$Resource$Spaces$Messages$Search, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        search(params?: Params$Resource$Spaces$Messages$Search, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SearchMessagesResponse>>;
        search(params: Params$Resource$Spaces$Messages$Search, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        search(params: Params$Resource$Spaces$Messages$Search, options: MethodOptions | BodyResponseCallback<Schema$SearchMessagesResponse>, callback: BodyResponseCallback<Schema$SearchMessagesResponse>): void;
        search(params: Params$Resource$Spaces$Messages$Search, callback: BodyResponseCallback<Schema$SearchMessagesResponse>): void;
    ...
    export class Resource$Users$Availability {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Users$Availability$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Users$Availability$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Availability>>;
        get(params: Params$Resource$Users$Availability$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Users$Availability$Get, options: MethodOptions | BodyResponseCallback<Schema$Availability>, callback: BodyResponseCallback<Schema$Availability>): void;
        get(params: Params$Resource$Users$Availability$Get, callback: BodyResponseCallback<Schema$Availability>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        markAsActive(params: Params$Resource$Users$Availability$Markasactive, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        markAsActive(params?: Params$Resource$Users$Availability$Markasactive, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Availability>>;
        markAsActive(params: Params$Resource$Users$Availability$Markasactive, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        markAsActive(params: Params$Resource$Users$Availability$Markasactive, options: MethodOptions | BodyResponseCallback<Schema$Availability>, callback: BodyResponseCallback<Schema$Availability>): void;
        markAsActive(params: Params$Resource$Users$Availability$Markasactive, callback: BodyResponseCallback<Schema$Availability>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        markAsAway(params: Params$Resource$Users$Availability$Markasaway, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        markAsAway(params?: Params$Resource$Users$Availability$Markasaway, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Availability>>;
        markAsAway(params: Params$Resource$Users$Availability$Markasaway, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        markAsAway(params: Params$Resource$Users$Availability$Markasaway, options: MethodOptions | BodyResponseCallback<Schema$Availability>, callback: BodyResponseCallback<Schema$Availability>): void;
        markAsAway(params: Params$Resource$Users$Availability$Markasaway, callback: BodyResponseCallback<Schema$Availability>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        markAsDoNotDisturb(params: Params$Resource$Users$Availability$Markasdonotdisturb, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        markAsDoNotDisturb(params?: Params$Resource$Users$Availability$Markasdonotdisturb, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Availability>>;
        markAsDoNotDisturb(params: Params$Resource$Users$Availability$Markasdonotdisturb, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        markAsDoNotDisturb(params: Params$Resource$Users$Availability$Markasdonotdisturb, options: MethodOptions | BodyResponseCallback<Schema$Availability>, callback: BodyResponseCallback<Schema$Availability>): void;
        markAsDoNotDisturb(params: Params$Resource$Users$Availability$Markasdonotdisturb, callback: BodyResponseCallback<Schema$Availability>): void;
        markAsDoNotDisturb(callback: BodyResponseCallback<Schema$Availability>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Users$Availability$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Users$Availability$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Availability>>;
        patch(params: Params$Resource$Users$Availability$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Users$Availability$Patch, options: MethodOptions | BodyResponseCallback<Schema$Availability>, callback: BodyResponseCallback<Schema$Availability>): void;
        patch(params: Params$Resource$Users$Availability$Patch, callback: BodyResponseCallback<Schema$Availability>): void;
