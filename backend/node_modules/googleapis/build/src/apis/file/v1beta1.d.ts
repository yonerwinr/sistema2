...
export declare namespace file_v1beta1 {
    ...
    export class Resource$Projects$Locations$Sharepools {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        acquireShare(params: Params$Resource$Projects$Locations$Sharepools$Acquireshare, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        acquireShare(params?: Params$Resource$Projects$Locations$Sharepools$Acquireshare, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AcquireShareResponse>>;
        acquireShare(params: Params$Resource$Projects$Locations$Sharepools$Acquireshare, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        acquireShare(params: Params$Resource$Projects$Locations$Sharepools$Acquireshare, options: MethodOptions | BodyResponseCallback<Schema$AcquireShareResponse>, callback: BodyResponseCallback<Schema$AcquireShareResponse>): void;
        acquireShare(params: Params$Resource$Projects$Locations$Sharepools$Acquireshare, callback: BodyResponseCallback<Schema$AcquireShareResponse>): void;
        acquireShare(callback: BodyResponseCallback<Schema$AcquireShareResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        releaseShare(params: Params$Resource$Projects$Locations$Sharepools$Releaseshare, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        releaseShare(params?: Params$Resource$Projects$Locations$Sharepools$Releaseshare, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ReleaseShareResponse>>;
        releaseShare(params: Params$Resource$Projects$Locations$Sharepools$Releaseshare, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        releaseShare(params: Params$Resource$Projects$Locations$Sharepools$Releaseshare, options: MethodOptions | BodyResponseCallback<Schema$ReleaseShareResponse>, callback: BodyResponseCallback<Schema$ReleaseShareResponse>): void;
        releaseShare(params: Params$Resource$Projects$Locations$Sharepools$Releaseshare, callback: BodyResponseCallback<Schema$ReleaseShareResponse>): void;
        releaseShare(callback: BodyResponseCallback<Schema$ReleaseShareResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Volumepools {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Volumepools$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Volumepools$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        create(params: Params$Resource$Projects$Locations$Volumepools$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Volumepools$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Projects$Locations$Volumepools$Create, callback: BodyResponseCallback<Schema$Operation>): void;
        create(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Volumepools$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Volumepools$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Projects$Locations$Volumepools$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Volumepools$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Projects$Locations$Volumepools$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Volumepools$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Volumepools$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$VolumePool>>;
        get(params: Params$Resource$Projects$Locations$Volumepools$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Volumepools$Get, options: MethodOptions | BodyResponseCallback<Schema$VolumePool>, callback: BodyResponseCallback<Schema$VolumePool>): void;
        get(params: Params$Resource$Projects$Locations$Volumepools$Get, callback: BodyResponseCallback<Schema$VolumePool>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Volumepools$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Volumepools$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListVolumePoolsResponse>>;
        list(params: Params$Resource$Projects$Locations$Volumepools$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Volumepools$List, options: MethodOptions | BodyResponseCallback<Schema$ListVolumePoolsResponse>, callback: BodyResponseCallback<Schema$ListVolumePoolsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Volumepools$List, callback: BodyResponseCallback<Schema$ListVolumePoolsResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Volumepools$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Volumepools$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        patch(params: Params$Resource$Projects$Locations$Volumepools$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Volumepools$Patch, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(params: Params$Resource$Projects$Locations$Volumepools$Patch, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(callback: BodyResponseCallback<Schema$Operation>): void;
    }
    ...
    export class Resource$Projects$Locations$Volumepools$Volumes {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Volumepools$Volumes$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Volumepools$Volumes$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Volume>>;
        create(params: Params$Resource$Projects$Locations$Volumepools$Volumes$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Volumepools$Volumes$Create, options: MethodOptions | BodyResponseCallback<Schema$Volume>, callback: BodyResponseCallback<Schema$Volume>): void;
        create(params: Params$Resource$Projects$Locations$Volumepools$Volumes$Create, callback: BodyResponseCallback<Schema$Volume>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Volumepools$Volumes$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Volumepools$Volumes$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Volumepools$Volumes$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Volumepools$Volumes$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Volumepools$Volumes$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Volumepools$Volumes$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Volumepools$Volumes$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Volume>>;
        get(params: Params$Resource$Projects$Locations$Volumepools$Volumes$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Volumepools$Volumes$Get, options: MethodOptions | BodyResponseCallback<Schema$Volume>, callback: BodyResponseCallback<Schema$Volume>): void;
        get(params: Params$Resource$Projects$Locations$Volumepools$Volumes$Get, callback: BodyResponseCallback<Schema$Volume>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Volumepools$Volumes$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Volumepools$Volumes$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListVolumesResponse>>;
        list(params: Params$Resource$Projects$Locations$Volumepools$Volumes$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Volumepools$Volumes$List, options: MethodOptions | BodyResponseCallback<Schema$ListVolumesResponse>, callback: BodyResponseCallback<Schema$ListVolumesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Volumepools$Volumes$List, callback: BodyResponseCallback<Schema$ListVolumesResponse>): void;
