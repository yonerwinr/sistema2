...
export declare namespace bigqueryreservation_v1 {
    ...
    export class Resource$Projects$Locations$Reservationgroups {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Reservationgroups$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Reservationgroups$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ReservationGroup>>;
        patch(params: Params$Resource$Projects$Locations$Reservationgroups$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Reservationgroups$Patch, options: MethodOptions | BodyResponseCallback<Schema$ReservationGroup>, callback: BodyResponseCallback<Schema$ReservationGroup>): void;
        patch(params: Params$Resource$Projects$Locations$Reservationgroups$Patch, callback: BodyResponseCallback<Schema$ReservationGroup>): void;
