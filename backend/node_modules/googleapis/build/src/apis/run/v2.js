...
(function (run_v2) {
    ...
    class Resource$Projects$Locations {
        ...
        constructor(context) {
            ...
            this.sourceUploads = new Resource$Projects$Locations$Sourceuploads(this.context);
    ...
    class Resource$Projects$Locations$Sourceuploads {
        context;
        constructor(context) {
            this.context = context;
        }
        upload(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2/{+parent}:uploadSource').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
                mediaUrl: (rootUrl + '/upload/v2/{+parent}:uploadSource').replace(/([^:]\/)\/+/g, '$1'),
                requiredParams: ['parent'],
                pathParams: ['parent'],
                context: this.context,
            };
    ...
    run_v2.Resource$Projects$Locations$Sourceuploads = Resource$Projects$Locations$Sourceuploads;
