...
export declare namespace run_v2 {
    ...
    export class Resource$Projects$Locations$Sourceuploads {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        upload(params: Params$Resource$Projects$Locations$Sourceuploads$Upload, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        upload(params?: Params$Resource$Projects$Locations$Sourceuploads$Upload, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudRunV2UploadSourceResponse>>;
        upload(params: Params$Resource$Projects$Locations$Sourceuploads$Upload, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        upload(params: Params$Resource$Projects$Locations$Sourceuploads$Upload, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRunV2UploadSourceResponse>, callback: BodyResponseCallback<Schema$GoogleCloudRunV2UploadSourceResponse>): void;
        upload(params: Params$Resource$Projects$Locations$Sourceuploads$Upload, callback: BodyResponseCallback<Schema$GoogleCloudRunV2UploadSourceResponse>): void;
        upload(callback: BodyResponseCallback<Schema$GoogleCloudRunV2UploadSourceResponse>): void;
    }
