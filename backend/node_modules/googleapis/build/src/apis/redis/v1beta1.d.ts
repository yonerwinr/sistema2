...
export declare namespace redis_v1beta1 {
    ...
    export class Resource$Projects$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getSharedRegionalCertificateAuthority(params: Params$Resource$Projects$Locations$Getsharedregionalcertificateauthority, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getSharedRegionalCertificateAuthority(params?: Params$Resource$Projects$Locations$Getsharedregionalcertificateauthority, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SharedRegionalCertificateAuthority>>;
        getSharedRegionalCertificateAuthority(params: Params$Resource$Projects$Locations$Getsharedregionalcertificateauthority, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getSharedRegionalCertificateAuthority(params: Params$Resource$Projects$Locations$Getsharedregionalcertificateauthority, options: MethodOptions | BodyResponseCallback<Schema$SharedRegionalCertificateAuthority>, callback: BodyResponseCallback<Schema$SharedRegionalCertificateAuthority>): void;
        getSharedRegionalCertificateAuthority(params: Params$Resource$Projects$Locations$Getsharedregionalcertificateauthority, callback: BodyResponseCallback<Schema$SharedRegionalCertificateAuthority>): void;
        getSharedRegionalCertificateAuthority(callback: BodyResponseCallback<Schema$SharedRegionalCertificateAuthority>): void;
        /**
    ...
    export class Resource$Projects$Locations$Aclpolicies {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Aclpolicies$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Aclpolicies$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AclPolicy>>;
        create(params: Params$Resource$Projects$Locations$Aclpolicies$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Aclpolicies$Create, options: MethodOptions | BodyResponseCallback<Schema$AclPolicy>, callback: BodyResponseCallback<Schema$AclPolicy>): void;
        create(params: Params$Resource$Projects$Locations$Aclpolicies$Create, callback: BodyResponseCallback<Schema$AclPolicy>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Aclpolicies$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Aclpolicies$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Projects$Locations$Aclpolicies$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Aclpolicies$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Projects$Locations$Aclpolicies$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Aclpolicies$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Aclpolicies$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AclPolicy>>;
        get(params: Params$Resource$Projects$Locations$Aclpolicies$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Aclpolicies$Get, options: MethodOptions | BodyResponseCallback<Schema$AclPolicy>, callback: BodyResponseCallback<Schema$AclPolicy>): void;
        get(params: Params$Resource$Projects$Locations$Aclpolicies$Get, callback: BodyResponseCallback<Schema$AclPolicy>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Aclpolicies$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Aclpolicies$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListAclPoliciesResponse>>;
        list(params: Params$Resource$Projects$Locations$Aclpolicies$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Aclpolicies$List, options: MethodOptions | BodyResponseCallback<Schema$ListAclPoliciesResponse>, callback: BodyResponseCallback<Schema$ListAclPoliciesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Aclpolicies$List, callback: BodyResponseCallback<Schema$ListAclPoliciesResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Aclpolicies$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Aclpolicies$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        patch(params: Params$Resource$Projects$Locations$Aclpolicies$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Aclpolicies$Patch, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(params: Params$Resource$Projects$Locations$Aclpolicies$Patch, callback: BodyResponseCallback<Schema$Operation>): void;
    ...
    export class Resource$Projects$Locations$Aclpolicies$Revisions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Aclpolicies$Revisions$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Aclpolicies$Revisions$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AclPolicyRevision>>;
        get(params: Params$Resource$Projects$Locations$Aclpolicies$Revisions$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Aclpolicies$Revisions$Get, options: MethodOptions | BodyResponseCallback<Schema$AclPolicyRevision>, callback: BodyResponseCallback<Schema$AclPolicyRevision>): void;
        get(params: Params$Resource$Projects$Locations$Aclpolicies$Revisions$Get, callback: BodyResponseCallback<Schema$AclPolicyRevision>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Aclpolicies$Revisions$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Aclpolicies$Revisions$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListAclPolicyRevisionsResponse>>;
        list(params: Params$Resource$Projects$Locations$Aclpolicies$Revisions$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Aclpolicies$Revisions$List, options: MethodOptions | BodyResponseCallback<Schema$ListAclPolicyRevisionsResponse>, callback: BodyResponseCallback<Schema$ListAclPolicyRevisionsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Aclpolicies$Revisions$List, callback: BodyResponseCallback<Schema$ListAclPolicyRevisionsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListAclPolicyRevisionsResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Clusters {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        addTokenAuthUser(params: Params$Resource$Projects$Locations$Clusters$Addtokenauthuser, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        addTokenAuthUser(params?: Params$Resource$Projects$Locations$Clusters$Addtokenauthuser, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        addTokenAuthUser(params: Params$Resource$Projects$Locations$Clusters$Addtokenauthuser, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        addTokenAuthUser(params: Params$Resource$Projects$Locations$Clusters$Addtokenauthuser, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        addTokenAuthUser(params: Params$Resource$Projects$Locations$Clusters$Addtokenauthuser, callback: BodyResponseCallback<Schema$Operation>): void;
    ...
    export class Resource$Projects$Locations$Clusters$Tokenauthusers {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        addAuthToken(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Addauthtoken, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        addAuthToken(params?: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Addauthtoken, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        addAuthToken(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Addauthtoken, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        addAuthToken(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Addauthtoken, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        addAuthToken(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Addauthtoken, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TokenAuthUser>>;
        get(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Get, options: MethodOptions | BodyResponseCallback<Schema$TokenAuthUser>, callback: BodyResponseCallback<Schema$TokenAuthUser>): void;
        get(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Get, callback: BodyResponseCallback<Schema$TokenAuthUser>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListTokenAuthUsersResponse>>;
        list(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$List, options: MethodOptions | BodyResponseCallback<Schema$ListTokenAuthUsersResponse>, callback: BodyResponseCallback<Schema$ListTokenAuthUsersResponse>): void;
        list(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$List, callback: BodyResponseCallback<Schema$ListTokenAuthUsersResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListTokenAuthUsersResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AuthToken>>;
        get(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$Get, options: MethodOptions | BodyResponseCallback<Schema$AuthToken>, callback: BodyResponseCallback<Schema$AuthToken>): void;
        get(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$Get, callback: BodyResponseCallback<Schema$AuthToken>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListAuthTokensResponse>>;
        list(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$List, options: MethodOptions | BodyResponseCallback<Schema$ListAuthTokensResponse>, callback: BodyResponseCallback<Schema$ListAuthTokensResponse>): void;
        list(params: Params$Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens$List, callback: BodyResponseCallback<Schema$ListAuthTokensResponse>): void;
