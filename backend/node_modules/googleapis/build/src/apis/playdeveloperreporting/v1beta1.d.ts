...
export declare namespace playdeveloperreporting_v1beta1 {
     ...
     */
    export interface Schema$GooglePlayDeveloperReportingV1beta1AnonRssAndSwapMemoryUsageMetricSet {
        /**
     ...
     */
    export interface Schema$GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet {
        /**
         * Output only. Summary about data freshness in this resource.
         */
        freshnessInfo?: Schema$GooglePlayDeveloperReportingV1beta1FreshnessInfo;
     ...
     */
    export interface Schema$GooglePlayDeveloperReportingV1beta1QueryAnonRssAndSwapMemoryUsageMetricSetRequest {
        /**
     ...
     */
    export interface Schema$GooglePlayDeveloperReportingV1beta1QueryAnonRssAndSwapMemoryUsageMetricSetResponse {
        /**
         * * Continuation token to fetch the next page of data.
         */
        nextPageToken?: string | null;
     ...
     */
    export interface Schema$GooglePlayDeveloperReportingV1beta1QueryBitmapMemoryUsageMetricSetRequest {
        /**
         * Optional. Dimensions to slice the data by. **Supported dimensions:** * `apiLevel` (string): the API level of Android that was running on the user's device, e.g., 26. * `versionCode` (int64): version of the app that was running on the user's device. * `deviceModel` (string): unique identifier of the user's device model. The form of the identifier is 'deviceBrand/device', where deviceBrand corresponds to Build.BRAND and device corresponds to Build.DEVICE, e.g., google/coral. * `deviceBrand` (string): unique identifier of the user's device brand, e.g., google. * `deviceType` (string): the type (also known as form factor) of the user's device, e.g., PHONE. * `countryCode` (string): the country or region of the user's device based on their IP address, represented as a 2-letter ISO-3166 code (e.g. US for the United States). * `deviceRamBucket` (int64): RAM of the device, in MB, in buckets (3GB, 4GB, etc.). * `deviceSocMake` (string): Make of the device's primary system-on-chip, e.g., Samsung. * `deviceSocModel` (string): Model of the device's primary system-on-chip, e.g., "Exynos 2100". * `deviceCpuMake` (string): Make of the device's CPU, e.g., Qualcomm. * `deviceCpuModel` (string): Model of the device's CPU, e.g., "Kryo 240". * `deviceGpuMake` (string): Make of the device's GPU, e.g., ARM. * `deviceGpuModel` (string): Model of the device's GPU, e.g., Mali. * `deviceGpuVersion` (string): Version of the device's GPU, e.g., T750. * `deviceVulkanVersion` (string): Vulkan version of the device, e.g., "4198400". * `deviceGlEsVersion` (string): OpenGL ES version of the device, e.g., "196610". * `deviceScreenSize` (string): Screen size of the device, e.g., NORMAL, LARGE. * `deviceScreenDpi` (string): Screen density of the device, e.g., mdpi, hdpi. * `processName` (string): the name of the process that was running, e.g., com.example.app. * `appState` (string): the state of the app when memory was collected, e.g., FOREGROUND.
         */
        dimensions?: string[] | null;
     ...
     */
    export interface Schema$GooglePlayDeveloperReportingV1beta1QueryBitmapMemoryUsageMetricSetResponse {
        /**
         * Continuation token to fetch the next page of data.
         */
        nextPageToken?: string | null;
    ...
    export class Resource$Vitals$Anonrssandswapmemoryusage {
        ...
        get(params?: Params$Resource$Vitals$Anonrssandswapmemoryusage$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GooglePlayDeveloperReportingV1beta1AnonRssAndSwapMemoryUsageMetricSet>>;
        ...
        get(params: Params$Resource$Vitals$Anonrssandswapmemoryusage$Get, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1AnonRssAndSwapMemoryUsageMetricSet>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1AnonRssAndSwapMemoryUsageMetricSet>): void;
        get(params: Params$Resource$Vitals$Anonrssandswapmemoryusage$Get, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1AnonRssAndSwapMemoryUsageMetricSet>): void;
        get(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1AnonRssAndSwapMemoryUsageMetricSet>): void;
        /**
        ...
        query(params?: Params$Resource$Vitals$Anonrssandswapmemoryusage$Query, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GooglePlayDeveloperReportingV1beta1QueryAnonRssAndSwapMemoryUsageMetricSetResponse>>;
        ...
        query(params: Params$Resource$Vitals$Anonrssandswapmemoryusage$Query, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1QueryAnonRssAndSwapMemoryUsageMetricSetResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1QueryAnonRssAndSwapMemoryUsageMetricSetResponse>): void;
        query(params: Params$Resource$Vitals$Anonrssandswapmemoryusage$Query, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1QueryAnonRssAndSwapMemoryUsageMetricSetResponse>): void;
        query(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1QueryAnonRssAndSwapMemoryUsageMetricSetResponse>): void;
    }
    ...
    export interface Params$Resource$Vitals$Anonrssandswapmemoryusage$Query extends StandardParameters {
         ...
         * Request body metadata
         */
        requestBody?: Schema$GooglePlayDeveloperReportingV1beta1QueryAnonRssAndSwapMemoryUsageMetricSetRequest;
    }
    ...
    export class Resource$Vitals$Bitmapmemoryusage {
        ...
        get(params?: Params$Resource$Vitals$Bitmapmemoryusage$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet>>;
        ...
        get(params: Params$Resource$Vitals$Bitmapmemoryusage$Get, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet>): void;
        get(params: Params$Resource$Vitals$Bitmapmemoryusage$Get, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet>): void;
        get(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet>): void;
        /**
         * Queries the metrics in the metric set.
         * @example
         * ```js
        ...
        query(params?: Params$Resource$Vitals$Bitmapmemoryusage$Query, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GooglePlayDeveloperReportingV1beta1QueryBitmapMemoryUsageMetricSetResponse>>;
        ...
        query(params: Params$Resource$Vitals$Bitmapmemoryusage$Query, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1QueryBitmapMemoryUsageMetricSetResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1QueryBitmapMemoryUsageMetricSetResponse>): void;
        query(params: Params$Resource$Vitals$Bitmapmemoryusage$Query, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1QueryBitmapMemoryUsageMetricSetResponse>): void;
        query(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1beta1QueryBitmapMemoryUsageMetricSetResponse>): void;
    }
