...
export declare namespace playdeveloperreporting_v1alpha1 {
     ...
     */
    export interface Schema$ApiservingMcpMcpToolVisibility {
        /**
         * A list of field-level visibility restrictions.
         */
        fieldVisibility?: Schema$ApiservingMcpMcpToolVisibilityFieldVisibility[];
        /**
     ...
     */
    export interface Schema$ApiservingMcpMcpToolVisibilityFieldVisibility {
        /**
     ...
     */
    export interface Schema$GooglePlayDeveloperReportingV1alpha1AnonRssAndSwapMemoryUsageMetricSet {
        /**
     ...
     */
    export interface Schema$GooglePlayDeveloperReportingV1alpha1BitmapMemoryUsageMetricSet {
        /**
         * Output only. Summary about data freshness in this resource.
         */
        freshnessInfo?: Schema$GooglePlayDeveloperReportingV1alpha1FreshnessInfo;
     ...
     */
    export interface Schema$GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest {
        /**
     ...
     */
    export interface Schema$GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetResponse {
        /**
         * * Continuation token to fetch the next page of data.
         */
        nextPageToken?: string | null;
     ...
     */
    export interface Schema$GooglePlayDeveloperReportingV1alpha1QueryBitmapMemoryUsageMetricSetRequest {
        /**
         * Optional. Dimensions to slice the data by. **Supported dimensions:** * `apiLevel` (string): the API level of Android that was running on the user's device, e.g., 26. * `versionCode` (int64): version of the app that was running on the user's device. * `deviceModel` (string): unique identifier of the user's device model. The form of the identifier is 'deviceBrand/device', where deviceBrand corresponds to Build.BRAND and device corresponds to Build.DEVICE, e.g., google/coral. * `deviceBrand` (string): unique identifier of the user's device brand, e.g., google. * `deviceType` (string): the type (also known as form factor) of the user's device, e.g., PHONE. * `countryCode` (string): the country or region of the user's device based on their IP address, represented as a 2-letter ISO-3166 code (e.g. US for the United States). * `deviceRamBucket` (int64): RAM of the device, in MB, in buckets (3GB, 4GB, etc.). * `deviceSocMake` (string): Make of the device's primary system-on-chip, e.g., Samsung. * `deviceSocModel` (string): Model of the device's primary system-on-chip, e.g., "Exynos 2100". * `deviceCpuMake` (string): Make of the device's CPU, e.g., Qualcomm. * `deviceCpuModel` (string): Model of the device's CPU, e.g., "Kryo 240". * `deviceGpuMake` (string): Make of the device's GPU, e.g., ARM. * `deviceGpuModel` (string): Model of the device's GPU, e.g., Mali. * `deviceGpuVersion` (string): Version of the device's GPU, e.g., T750. * `deviceVulkanVersion` (string): Vulkan version of the device, e.g., "4198400". * `deviceGlEsVersion` (string): OpenGL ES version of the device, e.g., "196610". * `deviceScreenSize` (string): Screen size of the device, e.g., NORMAL, LARGE. * `deviceScreenDpi` (string): Screen density of the device, e.g., mdpi, hdpi. * `processName` (string): the name of the process that was running, e.g., com.example.app. * `appState` (string): the state of the app when memory was collected, e.g., FOREGROUND.
         */
        dimensions?: string[] | null;
     ...
     */
    export interface Schema$GooglePlayDeveloperReportingV1alpha1QueryBitmapMemoryUsageMetricSetResponse {
        /**
         * Continuation token to fetch the next page of data.
         */
        nextPageToken?: string | null;
    ...
    export class Resource$Vitals {
        context: APIRequestContext;
        anonrssandswapmemoryusage: Resource$Vitals$Anonrssandswapmemoryusage;
        anrrate: Resource$Vitals$Anrrate;
        bitmapmemoryusage: Resource$Vitals$Bitmapmemoryusage;
    ...
    export class Resource$Vitals$Anonrssandswapmemoryusage {
        context: APIRequestContext;
        constructor(context: APIRequestContext);
        /**
         ...
         *
         *   // Do the magic
         *   const res = await playdeveloperreporting.vitals.anonrssandswapmemoryusage.get(
         *     {
         *       // Required. * The resource name. Format: apps/{app\}/anonRssAndSwapMemoryUsageMetricSet
         *       name: 'apps/my-app/anonRssAndSwapMemoryUsageMetricSet',
         *     },
         *   );
         *   console.log(res.data);
         *
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Vitals$Anonrssandswapmemoryusage$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Vitals$Anonrssandswapmemoryusage$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GooglePlayDeveloperReportingV1alpha1AnonRssAndSwapMemoryUsageMetricSet>>;
        get(params: Params$Resource$Vitals$Anonrssandswapmemoryusage$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Vitals$Anonrssandswapmemoryusage$Get, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1AnonRssAndSwapMemoryUsageMetricSet>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1AnonRssAndSwapMemoryUsageMetricSet>): void;
        get(params: Params$Resource$Vitals$Anonrssandswapmemoryusage$Get, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1AnonRssAndSwapMemoryUsageMetricSet>): void;
        get(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1AnonRssAndSwapMemoryUsageMetricSet>): void;
        /**
         ...
         *   // Do the magic
         *   const res =
         *     await playdeveloperreporting.vitals.anonrssandswapmemoryusage.query({
         *       // Required. * The resource name. Format: apps/{app\}/anonRssAndSwapMemoryUsageMetricSet
         *       name: 'apps/my-app/anonRssAndSwapMemoryUsageMetricSet',
         *
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        query(params: Params$Resource$Vitals$Anonrssandswapmemoryusage$Query, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        query(params?: Params$Resource$Vitals$Anonrssandswapmemoryusage$Query, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetResponse>>;
        query(params: Params$Resource$Vitals$Anonrssandswapmemoryusage$Query, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        query(params: Params$Resource$Vitals$Anonrssandswapmemoryusage$Query, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetResponse>): void;
        query(params: Params$Resource$Vitals$Anonrssandswapmemoryusage$Query, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetResponse>): void;
        query(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetResponse>): void;
    }
    export interface Params$Resource$Vitals$Anonrssandswapmemoryusage$Get extends StandardParameters {
        /**
         * Required. * The resource name. Format: apps/{app\}/anonRssAndSwapMemoryUsageMetricSet
         */
        name?: string;
    }
    export interface Params$Resource$Vitals$Anonrssandswapmemoryusage$Query extends StandardParameters {
        /**
         * Required. * The resource name. Format: apps/{app\}/anonRssAndSwapMemoryUsageMetricSet
         */
        name?: string;
         ...
         * Request body metadata
         */
        requestBody?: Schema$GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest;
    }
    ...
    export class Resource$Vitals$Bitmapmemoryusage {
        context: APIRequestContext;
        constructor(context: APIRequestContext);
        /**
         * Describes the properties of the metric set.
         ...
         *
         *   // Do the magic
         *   const res = await playdeveloperreporting.vitals.bitmapmemoryusage.get({
         *     // Required. The resource name. Format: apps/{app\}/bitmapMemoryUsageMetricSet
         *     name: 'apps/my-app/bitmapMemoryUsageMetricSet',
         *   });
         *   console.log(res.data);
         *
         *   // Example response
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Vitals$Bitmapmemoryusage$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Vitals$Bitmapmemoryusage$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GooglePlayDeveloperReportingV1alpha1BitmapMemoryUsageMetricSet>>;
        get(params: Params$Resource$Vitals$Bitmapmemoryusage$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Vitals$Bitmapmemoryusage$Get, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1BitmapMemoryUsageMetricSet>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1BitmapMemoryUsageMetricSet>): void;
        get(params: Params$Resource$Vitals$Bitmapmemoryusage$Get, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1BitmapMemoryUsageMetricSet>): void;
        get(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1BitmapMemoryUsageMetricSet>): void;
        /**
         * Queries the metrics in the metric set.
         * @example
         * ```js
         ...
         *
         *   // Do the magic
         *   const res = await playdeveloperreporting.vitals.bitmapmemoryusage.query({
         *     // Required. The resource name. Format: apps/{app\}/bitmapMemoryUsageMetricSet
         *     name: 'apps/my-app/bitmapMemoryUsageMetricSet',
         *
         *     // Request body metadata
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        query(params: Params$Resource$Vitals$Bitmapmemoryusage$Query, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        query(params?: Params$Resource$Vitals$Bitmapmemoryusage$Query, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GooglePlayDeveloperReportingV1alpha1QueryBitmapMemoryUsageMetricSetResponse>>;
        query(params: Params$Resource$Vitals$Bitmapmemoryusage$Query, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        query(params: Params$Resource$Vitals$Bitmapmemoryusage$Query, options: MethodOptions | BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryBitmapMemoryUsageMetricSetResponse>, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryBitmapMemoryUsageMetricSetResponse>): void;
        query(params: Params$Resource$Vitals$Bitmapmemoryusage$Query, callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryBitmapMemoryUsageMetricSetResponse>): void;
        query(callback: BodyResponseCallback<Schema$GooglePlayDeveloperReportingV1alpha1QueryBitmapMemoryUsageMetricSetResponse>): void;
    }
    export interface Params$Resource$Vitals$Bitmapmemoryusage$Get extends StandardParameters {
        /**
         * Required. The resource name. Format: apps/{app\}/bitmapMemoryUsageMetricSet
         */
        name?: string;
    }
    export interface Params$Resource$Vitals$Bitmapmemoryusage$Query extends StandardParameters {
        /**
         * Required. The resource name. Format: apps/{app\}/bitmapMemoryUsageMetricSet
         */
        name?: string;
