...
export declare namespace webcontentpublisher_v1 {
    ...
    export class Resource$Organizations$Publications$Ctas {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Organizations$Publications$Ctas$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Organizations$Publications$Ctas$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Cta>>;
        patch(params: Params$Resource$Organizations$Publications$Ctas$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Organizations$Publications$Ctas$Patch, options: MethodOptions | BodyResponseCallback<Schema$Cta>, callback: BodyResponseCallback<Schema$Cta>): void;
        patch(params: Params$Resource$Organizations$Publications$Ctas$Patch, callback: BodyResponseCallback<Schema$Cta>): void;
    ...
    export class Resource$Users {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generatePlatformSiteTokens(params: Params$Resource$Users$Generateplatformsitetokens, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        generatePlatformSiteTokens(params?: Params$Resource$Users$Generateplatformsitetokens, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GeneratePlatformSiteTokensResponse>>;
        generatePlatformSiteTokens(params: Params$Resource$Users$Generateplatformsitetokens, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        generatePlatformSiteTokens(params: Params$Resource$Users$Generateplatformsitetokens, options: MethodOptions | BodyResponseCallback<Schema$GeneratePlatformSiteTokensResponse>, callback: BodyResponseCallback<Schema$GeneratePlatformSiteTokensResponse>): void;
        generatePlatformSiteTokens(params: Params$Resource$Users$Generateplatformsitetokens, callback: BodyResponseCallback<Schema$GeneratePlatformSiteTokensResponse>): void;
        generatePlatformSiteTokens(callback: BodyResponseCallback<Schema$GeneratePlatformSiteTokensResponse>): void;
    }
