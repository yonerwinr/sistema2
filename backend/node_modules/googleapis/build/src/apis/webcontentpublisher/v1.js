...
(function (webcontentpublisher_v1) {
    ...
    class Resource$Users {
        ...
        generatePlatformSiteTokens(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:generatePlatformSiteTokens').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    webcontentpublisher_v1.Resource$Users = Resource$Users;
