...
export declare namespace dataproc_v1 {
    ...
    export class Resource$Projects$Locations$Batches$Sparkapplications {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        computeTuningConfig(params: Params$Resource$Projects$Locations$Batches$Sparkapplications$Computetuningconfig, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        computeTuningConfig(params?: Params$Resource$Projects$Locations$Batches$Sparkapplications$Computetuningconfig, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ComputeTuningConfigResponse>>;
        computeTuningConfig(params: Params$Resource$Projects$Locations$Batches$Sparkapplications$Computetuningconfig, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        computeTuningConfig(params: Params$Resource$Projects$Locations$Batches$Sparkapplications$Computetuningconfig, options: MethodOptions | BodyResponseCallback<Schema$ComputeTuningConfigResponse>, callback: BodyResponseCallback<Schema$ComputeTuningConfigResponse>): void;
        computeTuningConfig(params: Params$Resource$Projects$Locations$Batches$Sparkapplications$Computetuningconfig, callback: BodyResponseCallback<Schema$ComputeTuningConfigResponse>): void;
        computeTuningConfig(callback: BodyResponseCallback<Schema$ComputeTuningConfigResponse>): void;
        /**
