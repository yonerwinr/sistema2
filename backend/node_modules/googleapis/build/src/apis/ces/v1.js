...
(function (ces_v1) {
    ...
    class Resource$Projects$Locations$Apps {
        ...
        getExtendedAgentCard(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+tenant}/extendedAgentCard').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    class Resource$Projects$Locations$Apps$Deployments$Message {
        ...
        stream(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+tenant}/message:stream').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    ces_v1.Resource$Projects$Locations$Apps$Deployments$Message = Resource$Projects$Locations$Apps$Deployments$Message;
    ...
    ces_v1.Resource$Projects$Locations$Apps$Versions$Message = Resource$Projects$Locations$Apps$Versions$Message;
