...
export declare namespace developerconnect_v1 {
    ...
    export class Resource$Projects$Locations$Accountconnectors {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchUserRepositories(params: Params$Resource$Projects$Locations$Accountconnectors$Fetchuserrepositories, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchUserRepositories(params?: Params$Resource$Projects$Locations$Accountconnectors$Fetchuserrepositories, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchUserRepositoriesResponse>>;
        fetchUserRepositories(params: Params$Resource$Projects$Locations$Accountconnectors$Fetchuserrepositories, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetchUserRepositories(params: Params$Resource$Projects$Locations$Accountconnectors$Fetchuserrepositories, options: MethodOptions | BodyResponseCallback<Schema$FetchUserRepositoriesResponse>, callback: BodyResponseCallback<Schema$FetchUserRepositoriesResponse>): void;
        fetchUserRepositories(params: Params$Resource$Projects$Locations$Accountconnectors$Fetchuserrepositories, callback: BodyResponseCallback<Schema$FetchUserRepositoriesResponse>): void;
        fetchUserRepositories(callback: BodyResponseCallback<Schema$FetchUserRepositoriesResponse>): void;
        /**
