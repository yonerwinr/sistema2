...
export declare namespace androiddeveloperidstatus_v1 {
    ...
    export class Resource$Packages$Packageregistrationstatus {
         ...
         */
        check(params: Params$Resource$Packages$Packageregistrationstatus$Check, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        check(params?: Params$Resource$Packages$Packageregistrationstatus$Check, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$PackageRegistrationStatus>>;
        check(params: Params$Resource$Packages$Packageregistrationstatus$Check, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        check(params: Params$Resource$Packages$Packageregistrationstatus$Check, options: MethodOptions | BodyResponseCallback<Schema$PackageRegistrationStatus>, callback: BodyResponseCallback<Schema$PackageRegistrationStatus>): void;
        check(params: Params$Resource$Packages$Packageregistrationstatus$Check, callback: BodyResponseCallback<Schema$PackageRegistrationStatus>): void;
        check(callback: BodyResponseCallback<Schema$PackageRegistrationStatus>): void;
    }
