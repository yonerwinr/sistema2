...
export declare namespace firebaseappcheck_v1 {
    ...
    export class Resource$Projects$Apps {
        ...
        mintAppCheckToken(params?: Params$Resource$Projects$Apps$Mintappchecktoken, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenResponse>>;
        ...
        mintAppCheckToken(params: Params$Resource$Projects$Apps$Mintappchecktoken, options: MethodOptions | BodyResponseCallback<Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenResponse>, callback: BodyResponseCallback<Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenResponse>): void;
        mintAppCheckToken(params: Params$Resource$Projects$Apps$Mintappchecktoken, callback: BodyResponseCallback<Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenResponse>): void;
        mintAppCheckToken(callback: BodyResponseCallback<Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenResponse>): void;
    }
