...
export declare namespace firebaseappcheck_v1beta {
    ...
    export class Resource$Projects$Apps {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        mintAppCheckToken(params: Params$Resource$Projects$Apps$Mintappchecktoken, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        mintAppCheckToken(params?: Params$Resource$Projects$Apps$Mintappchecktoken, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleFirebaseAppcheckV1betaMintAppCheckTokenResponse>>;
        mintAppCheckToken(params: Params$Resource$Projects$Apps$Mintappchecktoken, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        mintAppCheckToken(params: Params$Resource$Projects$Apps$Mintappchecktoken, options: MethodOptions | BodyResponseCallback<Schema$GoogleFirebaseAppcheckV1betaMintAppCheckTokenResponse>, callback: BodyResponseCallback<Schema$GoogleFirebaseAppcheckV1betaMintAppCheckTokenResponse>): void;
        mintAppCheckToken(params: Params$Resource$Projects$Apps$Mintappchecktoken, callback: BodyResponseCallback<Schema$GoogleFirebaseAppcheckV1betaMintAppCheckTokenResponse>): void;
        mintAppCheckToken(callback: BodyResponseCallback<Schema$GoogleFirebaseAppcheckV1betaMintAppCheckTokenResponse>): void;
    }
