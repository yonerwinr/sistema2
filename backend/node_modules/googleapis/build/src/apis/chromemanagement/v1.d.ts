...
export declare namespace chromemanagement_v1 {
    ...
    export class Resource$Customers$Enterprise$Securityinsights {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        checkEnablementStatus(params: Params$Resource$Customers$Enterprise$Securityinsights$Checkenablementstatus, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        checkEnablementStatus(params?: Params$Resource$Customers$Enterprise$Securityinsights$Checkenablementstatus, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1CheckEnablementStatusResponse>>;
        checkEnablementStatus(params: Params$Resource$Customers$Enterprise$Securityinsights$Checkenablementstatus, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        checkEnablementStatus(params: Params$Resource$Customers$Enterprise$Securityinsights$Checkenablementstatus, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1CheckEnablementStatusResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1CheckEnablementStatusResponse>): void;
        checkEnablementStatus(params: Params$Resource$Customers$Enterprise$Securityinsights$Checkenablementstatus, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1CheckEnablementStatusResponse>): void;
        checkEnablementStatus(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1CheckEnablementStatusResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        disable(params: Params$Resource$Customers$Enterprise$Securityinsights$Disable, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        disable(params?: Params$Resource$Customers$Enterprise$Securityinsights$Disable, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1DisableInsightsResponse>>;
        disable(params: Params$Resource$Customers$Enterprise$Securityinsights$Disable, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        disable(params: Params$Resource$Customers$Enterprise$Securityinsights$Disable, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1DisableInsightsResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1DisableInsightsResponse>): void;
        disable(params: Params$Resource$Customers$Enterprise$Securityinsights$Disable, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1DisableInsightsResponse>): void;
        disable(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1DisableInsightsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        enable(params: Params$Resource$Customers$Enterprise$Securityinsights$Enable, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        enable(params?: Params$Resource$Customers$Enterprise$Securityinsights$Enable, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1EnableInsightsResponse>>;
        enable(params: Params$Resource$Customers$Enterprise$Securityinsights$Enable, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        enable(params: Params$Resource$Customers$Enterprise$Securityinsights$Enable, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1EnableInsightsResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1EnableInsightsResponse>): void;
        enable(params: Params$Resource$Customers$Enterprise$Securityinsights$Enable, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1EnableInsightsResponse>): void;
        enable(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1EnableInsightsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        queryContentTransfers(params: Params$Resource$Customers$Enterprise$Securityinsights$Querycontenttransfers, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        queryContentTransfers(params?: Params$Resource$Customers$Enterprise$Securityinsights$Querycontenttransfers, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1QueryContentTransfersResponse>>;
        queryContentTransfers(params: Params$Resource$Customers$Enterprise$Securityinsights$Querycontenttransfers, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        queryContentTransfers(params: Params$Resource$Customers$Enterprise$Securityinsights$Querycontenttransfers, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryContentTransfersResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryContentTransfersResponse>): void;
        queryContentTransfers(params: Params$Resource$Customers$Enterprise$Securityinsights$Querycontenttransfers, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryContentTransfersResponse>): void;
        queryContentTransfers(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryContentTransfersResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        queryContentTransfersBreakdowns(params: Params$Resource$Customers$Enterprise$Securityinsights$Querycontenttransfersbreakdowns, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        queryContentTransfersBreakdowns(params?: Params$Resource$Customers$Enterprise$Securityinsights$Querycontenttransfersbreakdowns, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1QueryContentTransfersBreakdownsResponse>>;
        queryContentTransfersBreakdowns(params: Params$Resource$Customers$Enterprise$Securityinsights$Querycontenttransfersbreakdowns, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        queryContentTransfersBreakdowns(params: Params$Resource$Customers$Enterprise$Securityinsights$Querycontenttransfersbreakdowns, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryContentTransfersBreakdownsResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryContentTransfersBreakdownsResponse>): void;
        queryContentTransfersBreakdowns(params: Params$Resource$Customers$Enterprise$Securityinsights$Querycontenttransfersbreakdowns, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryContentTransfersBreakdownsResponse>): void;
        queryContentTransfersBreakdowns(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryContentTransfersBreakdownsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        queryUrlVisits(params: Params$Resource$Customers$Enterprise$Securityinsights$Queryurlvisits, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        queryUrlVisits(params?: Params$Resource$Customers$Enterprise$Securityinsights$Queryurlvisits, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1QueryUrlVisitsResponse>>;
        queryUrlVisits(params: Params$Resource$Customers$Enterprise$Securityinsights$Queryurlvisits, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        queryUrlVisits(params: Params$Resource$Customers$Enterprise$Securityinsights$Queryurlvisits, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryUrlVisitsResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryUrlVisitsResponse>): void;
        queryUrlVisits(params: Params$Resource$Customers$Enterprise$Securityinsights$Queryurlvisits, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryUrlVisitsResponse>): void;
        queryUrlVisits(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryUrlVisitsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        queryUrlVisitsBreakdowns(params: Params$Resource$Customers$Enterprise$Securityinsights$Queryurlvisitsbreakdowns, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        queryUrlVisitsBreakdowns(params?: Params$Resource$Customers$Enterprise$Securityinsights$Queryurlvisitsbreakdowns, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1QueryUrlVisitsBreakdownsResponse>>;
        queryUrlVisitsBreakdowns(params: Params$Resource$Customers$Enterprise$Securityinsights$Queryurlvisitsbreakdowns, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        queryUrlVisitsBreakdowns(params: Params$Resource$Customers$Enterprise$Securityinsights$Queryurlvisitsbreakdowns, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryUrlVisitsBreakdownsResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryUrlVisitsBreakdownsResponse>): void;
        queryUrlVisitsBreakdowns(params: Params$Resource$Customers$Enterprise$Securityinsights$Queryurlvisitsbreakdowns, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryUrlVisitsBreakdownsResponse>): void;
        queryUrlVisitsBreakdowns(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1QueryUrlVisitsBreakdownsResponse>): void;
    }
    ...
    export class Resource$Customers$Reports {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countChromeProfileVersions(params: Params$Resource$Customers$Reports$Countchromeprofileversions, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countChromeProfileVersions(params?: Params$Resource$Customers$Reports$Countchromeprofileversions, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountChromeProfileVersionsResponse>>;
        countChromeProfileVersions(params: Params$Resource$Customers$Reports$Countchromeprofileversions, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        countChromeProfileVersions(params: Params$Resource$Customers$Reports$Countchromeprofileversions, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementV1CountChromeProfileVersionsResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1CountChromeProfileVersionsResponse>): void;
        countChromeProfileVersions(params: Params$Resource$Customers$Reports$Countchromeprofileversions, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1CountChromeProfileVersionsResponse>): void;
        countChromeProfileVersions(callback: BodyResponseCallback<Schema$GoogleChromeManagementV1CountChromeProfileVersionsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        findSaasUsage(params: Params$Resource$Customers$Reports$Findsaasusage, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        findSaasUsage(params?: Params$Resource$Customers$Reports$Findsaasusage, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1FindSaasUsageReportsResponse>>;
        findSaasUsage(params: Params$Resource$Customers$Reports$Findsaasusage, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        findSaasUsage(params: Params$Resource$Customers$Reports$Findsaasusage, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementV1FindSaasUsageReportsResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1FindSaasUsageReportsResponse>): void;
        findSaasUsage(params: Params$Resource$Customers$Reports$Findsaasusage, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1FindSaasUsageReportsResponse>): void;
        findSaasUsage(callback: BodyResponseCallback<Schema$GoogleChromeManagementV1FindSaasUsageReportsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        findSaasUsageBrowsers(params: Params$Resource$Customers$Reports$Findsaasusagebrowsers, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        findSaasUsageBrowsers(params?: Params$Resource$Customers$Reports$Findsaasusagebrowsers, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1FindSaasUsageBrowsersResponse>>;
        findSaasUsageBrowsers(params: Params$Resource$Customers$Reports$Findsaasusagebrowsers, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        findSaasUsageBrowsers(params: Params$Resource$Customers$Reports$Findsaasusagebrowsers, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementV1FindSaasUsageBrowsersResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1FindSaasUsageBrowsersResponse>): void;
        findSaasUsageBrowsers(params: Params$Resource$Customers$Reports$Findsaasusagebrowsers, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1FindSaasUsageBrowsersResponse>): void;
        findSaasUsageBrowsers(callback: BodyResponseCallback<Schema$GoogleChromeManagementV1FindSaasUsageBrowsersResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        findSaasUsageProfiles(params: Params$Resource$Customers$Reports$Findsaasusageprofiles, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        findSaasUsageProfiles(params?: Params$Resource$Customers$Reports$Findsaasusageprofiles, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1FindSaasUsageProfilesResponse>>;
        findSaasUsageProfiles(params: Params$Resource$Customers$Reports$Findsaasusageprofiles, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        findSaasUsageProfiles(params: Params$Resource$Customers$Reports$Findsaasusageprofiles, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementV1FindSaasUsageProfilesResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1FindSaasUsageProfilesResponse>): void;
        findSaasUsageProfiles(params: Params$Resource$Customers$Reports$Findsaasusageprofiles, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1FindSaasUsageProfilesResponse>): void;
        findSaasUsageProfiles(callback: BodyResponseCallback<Schema$GoogleChromeManagementV1FindSaasUsageProfilesResponse>): void;
    }
