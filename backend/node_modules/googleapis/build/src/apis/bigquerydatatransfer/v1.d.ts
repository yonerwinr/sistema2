...
export declare namespace bigquerydatatransfer_v1 {
    ...
    export class Resource$Projects$Locations$Transferconfigs$Transferresources {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Transferconfigs$Transferresources$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Transferconfigs$Transferresources$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TransferResource>>;
        get(params: Params$Resource$Projects$Locations$Transferconfigs$Transferresources$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Transferconfigs$Transferresources$Get, options: MethodOptions | BodyResponseCallback<Schema$TransferResource>, callback: BodyResponseCallback<Schema$TransferResource>): void;
        get(params: Params$Resource$Projects$Locations$Transferconfigs$Transferresources$Get, callback: BodyResponseCallback<Schema$TransferResource>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Transferconfigs$Transferresources$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Transferconfigs$Transferresources$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListTransferResourcesResponse>>;
        list(params: Params$Resource$Projects$Locations$Transferconfigs$Transferresources$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Transferconfigs$Transferresources$List, options: MethodOptions | BodyResponseCallback<Schema$ListTransferResourcesResponse>, callback: BodyResponseCallback<Schema$ListTransferResourcesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Transferconfigs$Transferresources$List, callback: BodyResponseCallback<Schema$ListTransferResourcesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListTransferResourcesResponse>): void;
    }
    ...
    export class Resource$Projects$Transferconfigs$Transferresources {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Transferconfigs$Transferresources$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Transferconfigs$Transferresources$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TransferResource>>;
        get(params: Params$Resource$Projects$Transferconfigs$Transferresources$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Transferconfigs$Transferresources$Get, options: MethodOptions | BodyResponseCallback<Schema$TransferResource>, callback: BodyResponseCallback<Schema$TransferResource>): void;
        get(params: Params$Resource$Projects$Transferconfigs$Transferresources$Get, callback: BodyResponseCallback<Schema$TransferResource>): void;
        get(callback: BodyResponseCallback<Schema$TransferResource>): void;
        /**
         * Returns information about transfer resources.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Transferconfigs$Transferresources$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Transferconfigs$Transferresources$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListTransferResourcesResponse>>;
        list(params: Params$Resource$Projects$Transferconfigs$Transferresources$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Transferconfigs$Transferresources$List, options: MethodOptions | BodyResponseCallback<Schema$ListTransferResourcesResponse>, callback: BodyResponseCallback<Schema$ListTransferResourcesResponse>): void;
        list(params: Params$Resource$Projects$Transferconfigs$Transferresources$List, callback: BodyResponseCallback<Schema$ListTransferResourcesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListTransferResourcesResponse>): void;
    }
