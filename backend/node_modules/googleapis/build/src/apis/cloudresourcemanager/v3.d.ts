...
export declare namespace cloudresourcemanager_v3 {
    ...
    export class Resource$Locations$Tagbindingcollections {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Locations$Tagbindingcollections$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Locations$Tagbindingcollections$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        patch(params: Params$Resource$Locations$Tagbindingcollections$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Locations$Tagbindingcollections$Patch, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(params: Params$Resource$Locations$Tagbindingcollections$Patch, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(callback: BodyResponseCallback<Schema$Operation>): void;
    }
    ...
    export class Resource$V3 {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchResourceSemantics(params: Params$Resource$V3$Fetchresourcesemantics, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchResourceSemantics(params?: Params$Resource$V3$Fetchresourcesemantics, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchResourceSemanticsResponse>>;
        fetchResourceSemantics(params: Params$Resource$V3$Fetchresourcesemantics, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetchResourceSemantics(params: Params$Resource$V3$Fetchresourcesemantics, options: MethodOptions | BodyResponseCallback<Schema$FetchResourceSemanticsResponse>, callback: BodyResponseCallback<Schema$FetchResourceSemanticsResponse>): void;
        fetchResourceSemantics(params: Params$Resource$V3$Fetchresourcesemantics, callback: BodyResponseCallback<Schema$FetchResourceSemanticsResponse>): void;
        fetchResourceSemantics(callback: BodyResponseCallback<Schema$FetchResourceSemanticsResponse>): void;
    }
