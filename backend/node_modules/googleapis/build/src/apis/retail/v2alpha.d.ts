...
export declare namespace retail_v2alpha {
     ...
     */
    export interface Schema$GoogleCloudRetailV2alphaCompleteQueryResponseAgentPrompt {
        /**
    ...
    export interface Schema$GoogleCloudRetailV2alphaSearchRequest {
         ...
         */
        dynamicControls?: Schema$GoogleCloudRetailV2alphaControl[];
        /**
