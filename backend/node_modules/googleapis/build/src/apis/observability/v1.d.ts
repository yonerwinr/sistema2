...
export declare namespace observability_v1 {
    ...
    export class Resource$Projects$Locations$Buckets {
         ...
         *
         *   // Do the magic
         *   const res = await observability.projects.locations.buckets.create({
        ...
        create(params?: Params$Resource$Projects$Locations$Buckets$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        ...
        create(params: Params$Resource$Projects$Locations$Buckets$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Projects$Locations$Buckets$Create, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         *
         *   // Do the magic
         *   const res = await observability.projects.locations.buckets.patch({
         *     // Identifier. Name of the bucket. The format is: projects/[PROJECT_ID]/locations/[LOCATION]/buckets/[BUCKET_ID]
         *     name: 'projects/my-project/locations/my-location/buckets/my-bucket',
        ...
        patch(params?: Params$Resource$Projects$Locations$Buckets$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        ...
        patch(params: Params$Resource$Projects$Locations$Buckets$Patch, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(params: Params$Resource$Projects$Locations$Buckets$Patch, callback: BodyResponseCallback<Schema$Operation>): void;
