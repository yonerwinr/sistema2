...
export declare namespace firestore_v1 {
    ...
    export class Resource$Projects$Databases$Changestreams {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Databases$Changestreams$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Databases$Changestreams$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleFirestoreAdminV1ChangeStream>>;
        create(params: Params$Resource$Projects$Databases$Changestreams$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Databases$Changestreams$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleFirestoreAdminV1ChangeStream>, callback: BodyResponseCallback<Schema$GoogleFirestoreAdminV1ChangeStream>): void;
        create(params: Params$Resource$Projects$Databases$Changestreams$Create, callback: BodyResponseCallback<Schema$GoogleFirestoreAdminV1ChangeStream>): void;
        create(callback: BodyResponseCallback<Schema$GoogleFirestoreAdminV1ChangeStream>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Databases$Changestreams$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Databases$Changestreams$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Databases$Changestreams$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Databases$Changestreams$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Databases$Changestreams$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Databases$Changestreams$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Databases$Changestreams$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleFirestoreAdminV1ChangeStream>>;
        get(params: Params$Resource$Projects$Databases$Changestreams$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Databases$Changestreams$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleFirestoreAdminV1ChangeStream>, callback: BodyResponseCallback<Schema$GoogleFirestoreAdminV1ChangeStream>): void;
        get(params: Params$Resource$Projects$Databases$Changestreams$Get, callback: BodyResponseCallback<Schema$GoogleFirestoreAdminV1ChangeStream>): void;
        get(callback: BodyResponseCallback<Schema$GoogleFirestoreAdminV1ChangeStream>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Databases$Changestreams$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Databases$Changestreams$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleFirestoreAdminV1ListChangeStreamsResponse>>;
        list(params: Params$Resource$Projects$Databases$Changestreams$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Databases$Changestreams$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleFirestoreAdminV1ListChangeStreamsResponse>, callback: BodyResponseCallback<Schema$GoogleFirestoreAdminV1ListChangeStreamsResponse>): void;
        list(params: Params$Resource$Projects$Databases$Changestreams$List, callback: BodyResponseCallback<Schema$GoogleFirestoreAdminV1ListChangeStreamsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleFirestoreAdminV1ListChangeStreamsResponse>): void;
    }
