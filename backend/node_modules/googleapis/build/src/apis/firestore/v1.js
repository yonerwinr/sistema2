...
(function (firestore_v1) {
    ...
    class Resource$Projects$Databases {
        ...
        constructor(context) {
            ...
            this.changeStreams = new Resource$Projects$Databases$Changestreams(this.context);
    ...
    class Resource$Projects$Databases$Changestreams {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/changeStreams').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    firestore_v1.Resource$Projects$Databases$Changestreams = Resource$Projects$Databases$Changestreams;
