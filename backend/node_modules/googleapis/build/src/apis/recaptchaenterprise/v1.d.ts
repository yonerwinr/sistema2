...
export declare namespace recaptchaenterprise_v1 {
    ...
    export class Resource$Projects$Keys {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getPolicy(params: Params$Resource$Projects$Keys$Getpolicy, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getPolicy(params?: Params$Resource$Projects$Keys$Getpolicy, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudRecaptchaenterpriseV1Policy>>;
        getPolicy(params: Params$Resource$Projects$Keys$Getpolicy, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getPolicy(params: Params$Resource$Projects$Keys$Getpolicy, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRecaptchaenterpriseV1Policy>, callback: BodyResponseCallback<Schema$GoogleCloudRecaptchaenterpriseV1Policy>): void;
        getPolicy(params: Params$Resource$Projects$Keys$Getpolicy, callback: BodyResponseCallback<Schema$GoogleCloudRecaptchaenterpriseV1Policy>): void;
        getPolicy(callback: BodyResponseCallback<Schema$GoogleCloudRecaptchaenterpriseV1Policy>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updatePolicy(params: Params$Resource$Projects$Keys$Updatepolicy, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        updatePolicy(params?: Params$Resource$Projects$Keys$Updatepolicy, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudRecaptchaenterpriseV1Policy>>;
        updatePolicy(params: Params$Resource$Projects$Keys$Updatepolicy, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        updatePolicy(params: Params$Resource$Projects$Keys$Updatepolicy, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRecaptchaenterpriseV1Policy>, callback: BodyResponseCallback<Schema$GoogleCloudRecaptchaenterpriseV1Policy>): void;
        updatePolicy(params: Params$Resource$Projects$Keys$Updatepolicy, callback: BodyResponseCallback<Schema$GoogleCloudRecaptchaenterpriseV1Policy>): void;
        updatePolicy(callback: BodyResponseCallback<Schema$GoogleCloudRecaptchaenterpriseV1Policy>): void;
    }
