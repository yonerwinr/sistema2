...
export declare namespace docs_v1 {
     ...
     */
    export interface Schema$InsertRichLinkRequest {
        /**
    ...
    export interface Schema$Request {
         ...
         * Insert a rich link.
         */
        insertRichLink?: Schema$InsertRichLinkRequest;
        /**
         ...
         */
        updateNamedStyle?: Schema$UpdateNamedStyleRequest;
        /**
     ...
     * Updates a named style.
     */
    export interface Schema$UpdateNamedStyleRequest {
        /**
