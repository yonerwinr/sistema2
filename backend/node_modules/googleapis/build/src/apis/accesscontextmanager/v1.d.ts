...
export declare namespace accesscontextmanager_v1 {
    ...
    export class Resource$Folders {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        lookupConfiguredServicePerimeter(params: Params$Resource$Folders$Lookupconfiguredserviceperimeter, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        lookupConfiguredServicePerimeter(params?: Params$Resource$Folders$Lookupconfiguredserviceperimeter, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$LookupConfiguredServicePerimeterResponse>>;
        lookupConfiguredServicePerimeter(params: Params$Resource$Folders$Lookupconfiguredserviceperimeter, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        lookupConfiguredServicePerimeter(params: Params$Resource$Folders$Lookupconfiguredserviceperimeter, options: MethodOptions | BodyResponseCallback<Schema$LookupConfiguredServicePerimeterResponse>, callback: BodyResponseCallback<Schema$LookupConfiguredServicePerimeterResponse>): void;
        lookupConfiguredServicePerimeter(params: Params$Resource$Folders$Lookupconfiguredserviceperimeter, callback: BodyResponseCallback<Schema$LookupConfiguredServicePerimeterResponse>): void;
        lookupConfiguredServicePerimeter(callback: BodyResponseCallback<Schema$LookupConfiguredServicePerimeterResponse>): void;
    }
    ...
    export class Resource$Permissions {
        ...
        list(params?: Params$Resource$Permissions$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListSupportedPermissionsResponse>>;
        ...
        list(params: Params$Resource$Permissions$List, options: MethodOptions | BodyResponseCallback<Schema$ListSupportedPermissionsResponse>, callback: BodyResponseCallback<Schema$ListSupportedPermissionsResponse>): void;
        list(params: Params$Resource$Permissions$List, callback: BodyResponseCallback<Schema$ListSupportedPermissionsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListSupportedPermissionsResponse>): void;
    }
    ...
    export class Resource$Projects {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        lookupConfiguredServicePerimeter(params: Params$Resource$Projects$Lookupconfiguredserviceperimeter, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        lookupConfiguredServicePerimeter(params?: Params$Resource$Projects$Lookupconfiguredserviceperimeter, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$LookupConfiguredServicePerimeterResponse>>;
        lookupConfiguredServicePerimeter(params: Params$Resource$Projects$Lookupconfiguredserviceperimeter, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        lookupConfiguredServicePerimeter(params: Params$Resource$Projects$Lookupconfiguredserviceperimeter, options: MethodOptions | BodyResponseCallback<Schema$LookupConfiguredServicePerimeterResponse>, callback: BodyResponseCallback<Schema$LookupConfiguredServicePerimeterResponse>): void;
        lookupConfiguredServicePerimeter(params: Params$Resource$Projects$Lookupconfiguredserviceperimeter, callback: BodyResponseCallback<Schema$LookupConfiguredServicePerimeterResponse>): void;
        lookupConfiguredServicePerimeter(callback: BodyResponseCallback<Schema$LookupConfiguredServicePerimeterResponse>): void;
    }
