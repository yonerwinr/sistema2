...
(function (accesscontextmanager_v1) {
    ...
    class Resource$Folders {
        ...
        lookupConfiguredServicePerimeter(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+resource}:lookupConfiguredServicePerimeter').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    accesscontextmanager_v1.Resource$Folders = Resource$Folders;
    ...
    accesscontextmanager_v1.Resource$Projects = Resource$Projects;
