...
export declare namespace walletobjects_v1 {
    ...
    export class Resource$Jwt {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        validate(params: Params$Resource$Jwt$Validate, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        validate(params?: Params$Resource$Jwt$Validate, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$JwtValidateResponse>>;
        validate(params: Params$Resource$Jwt$Validate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        validate(params: Params$Resource$Jwt$Validate, options: MethodOptions | BodyResponseCallback<Schema$JwtValidateResponse>, callback: BodyResponseCallback<Schema$JwtValidateResponse>): void;
        validate(params: Params$Resource$Jwt$Validate, callback: BodyResponseCallback<Schema$JwtValidateResponse>): void;
