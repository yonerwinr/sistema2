...
export declare namespace cloudnumberregistry_v1alpha {
     ...
     */
    export interface Schema$ListOrgNumberRegistriesResponse {
        /**
         * A token to retrieve the next page of results, or empty if there are no more results in the list.
         */
        nextPageToken?: string | null;
         ...
         */
        orgNumberRegistries?: Schema$OrgNumberRegistry[];
        /**
         * Locations that could not be reached.
         */
        unreachable?: string[] | null;
     ...
     */
    export interface Schema$OrgNumberRegistry {
        /**
    ...
    export class Resource$Organizations$Locations {
        ...
        orgNumberRegistries: Resource$Organizations$Locations$Orgnumberregistries;
        constructor(context: APIRequestContext);
    }
    export class Resource$Organizations$Locations$Operations {
         ...
         *   // Do the magic
         *   const res =
         *     await cloudnumberregistry.organizations.locations.operations.cancel({
         ...
         *   // Do the magic
         *   const res =
         *     await cloudnumberregistry.organizations.locations.operations.delete({
         ...
         *
         *   // Do the magic
         *   const res = await cloudnumberregistry.organizations.locations.operations.get({
         ...
         *
         *   // Do the magic
         *   const res = await cloudnumberregistry.organizations.locations.operations.list(
         *     {
    ...
    export class Resource$Organizations$Locations$Orgnumberregistries {
        context: APIRequestContext;
        constructor(context: APIRequestContext);
        /**
         ...
         *   // Do the magic
         *   const res =
         *     await cloudnumberregistry.organizations.locations.orgNumberRegistries.create(
         *       {
         *         // Required. The ID to use for the OrgNumberRegistry, which will become the final segment of the resource name.
         *         orgNumberRegistryId: 'placeholder-value',
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Organizations$Locations$Orgnumberregistries$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Organizations$Locations$Orgnumberregistries$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        create(params: Params$Resource$Organizations$Locations$Orgnumberregistries$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Organizations$Locations$Orgnumberregistries$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Organizations$Locations$Orgnumberregistries$Create, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         *   // Do the magic
         *   const res =
         *     await cloudnumberregistry.organizations.locations.orgNumberRegistries.delete(
         *       {
         *         // Required. The resource name of the OrgNumberRegistry to delete.
         *         name: 'organizations/my-organization/locations/my-location/orgNumberRegistries/my-orgNumberRegistrie',
         *         // Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes after the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
         *         requestId: 'placeholder-value',
         *       },
         *     );
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Organizations$Locations$Orgnumberregistries$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Organizations$Locations$Orgnumberregistries$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Organizations$Locations$Orgnumberregistries$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Organizations$Locations$Orgnumberregistries$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Organizations$Locations$Orgnumberregistries$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         *   // Do the magic
         *   const res =
         *     await cloudnumberregistry.organizations.locations.orgNumberRegistries.get({
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Organizations$Locations$Orgnumberregistries$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Organizations$Locations$Orgnumberregistries$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$OrgNumberRegistry>>;
        get(params: Params$Resource$Organizations$Locations$Orgnumberregistries$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Organizations$Locations$Orgnumberregistries$Get, options: MethodOptions | BodyResponseCallback<Schema$OrgNumberRegistry>, callback: BodyResponseCallback<Schema$OrgNumberRegistry>): void;
        get(params: Params$Resource$Organizations$Locations$Orgnumberregistries$Get, callback: BodyResponseCallback<Schema$OrgNumberRegistry>): void;
        get(callback: BodyResponseCallback<Schema$OrgNumberRegistry>): void;
        /**
         ...
         *   // Do the magic
         *   const res =
         *     await cloudnumberregistry.organizations.locations.orgNumberRegistries.list({
         ...
         *       // Optional. A token identifying a page of results the server should return.
         *       pageToken: 'placeholder-value',
         *       // Required. The parent resource name, for example `organizations/x/locations/x`.
         *       parent: 'organizations/my-organization/locations/my-location',
         *     });
         *   console.log(res.data);
         *
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Organizations$Locations$Orgnumberregistries$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Organizations$Locations$Orgnumberregistries$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListOrgNumberRegistriesResponse>>;
        list(params: Params$Resource$Organizations$Locations$Orgnumberregistries$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Organizations$Locations$Orgnumberregistries$List, options: MethodOptions | BodyResponseCallback<Schema$ListOrgNumberRegistriesResponse>, callback: BodyResponseCallback<Schema$ListOrgNumberRegistriesResponse>): void;
        list(params: Params$Resource$Organizations$Locations$Orgnumberregistries$List, callback: BodyResponseCallback<Schema$ListOrgNumberRegistriesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListOrgNumberRegistriesResponse>): void;
    }
    export interface Params$Resource$Organizations$Locations$Orgnumberregistries$Create extends StandardParameters {
        /**
         * Required. The ID to use for the OrgNumberRegistry, which will become the final segment of the resource name.
         */
    ...
    export interface Params$Resource$Organizations$Locations$Orgnumberregistries$Delete extends StandardParameters {
        /**
         * Required. The resource name of the OrgNumberRegistry to delete.
         */
        name?: string;
    ...
    export interface Params$Resource$Organizations$Locations$Orgnumberregistries$Get extends StandardParameters {
        /**
         * Required. The resource name of the OrgNumberRegistry to retrieve.
         */
        name?: string;
    }
    export interface Params$Resource$Organizations$Locations$Orgnumberregistries$List extends StandardParameters {
        /**
         * Optional. Filter expression to filter the results.
         */
        filter?: string;
