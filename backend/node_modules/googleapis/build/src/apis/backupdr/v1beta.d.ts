...
export declare namespace backupdr_v1beta {
    ...
    export class Resource$Projects$Locations$Appliedautoprotectionpolicies {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Appliedautoprotectionpolicies$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Appliedautoprotectionpolicies$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListAppliedAutoProtectionPoliciesResponse>>;
        list(params: Params$Resource$Projects$Locations$Appliedautoprotectionpolicies$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Appliedautoprotectionpolicies$List, options: MethodOptions | BodyResponseCallback<Schema$ListAppliedAutoProtectionPoliciesResponse>, callback: BodyResponseCallback<Schema$ListAppliedAutoProtectionPoliciesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Appliedautoprotectionpolicies$List, callback: BodyResponseCallback<Schema$ListAppliedAutoProtectionPoliciesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListAppliedAutoProtectionPoliciesResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Autoprotectionpolicies {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Autoprotectionpolicies$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        create(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Create, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Autoprotectionpolicies$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Autoprotectionpolicies$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AutoProtectionPolicy>>;
        get(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Get, options: MethodOptions | BodyResponseCallback<Schema$AutoProtectionPolicy>, callback: BodyResponseCallback<Schema$AutoProtectionPolicy>): void;
        get(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Get, callback: BodyResponseCallback<Schema$AutoProtectionPolicy>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Autoprotectionpolicies$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListAutoProtectionPoliciesResponse>>;
        list(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$List, options: MethodOptions | BodyResponseCallback<Schema$ListAutoProtectionPoliciesResponse>, callback: BodyResponseCallback<Schema$ListAutoProtectionPoliciesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$List, callback: BodyResponseCallback<Schema$ListAutoProtectionPoliciesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListAutoProtectionPoliciesResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Autoprotectionpolicies$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        patch(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Patch, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Patch, callback: BodyResponseCallback<Schema$Operation>): void;
    ...
    export class Resource$Projects$Locations$Autoprotectionpolicies$Bindings {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        create(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Create, callback: BodyResponseCallback<Schema$Operation>): void;
        create(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$AutoProtectionPolicyBinding>>;
        get(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Get, options: MethodOptions | BodyResponseCallback<Schema$AutoProtectionPolicyBinding>, callback: BodyResponseCallback<Schema$AutoProtectionPolicyBinding>): void;
        get(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Get, callback: BodyResponseCallback<Schema$AutoProtectionPolicyBinding>): void;
        get(callback: BodyResponseCallback<Schema$AutoProtectionPolicyBinding>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        initiateDelete(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Initiatedelete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        initiateDelete(params?: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Initiatedelete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        initiateDelete(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Initiatedelete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        initiateDelete(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Initiatedelete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        initiateDelete(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Initiatedelete, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListAutoProtectionPolicyBindingsResponse>>;
        list(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$List, options: MethodOptions | BodyResponseCallback<Schema$ListAutoProtectionPolicyBindingsResponse>, callback: BodyResponseCallback<Schema$ListAutoProtectionPolicyBindingsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$List, callback: BodyResponseCallback<Schema$ListAutoProtectionPolicyBindingsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListAutoProtectionPolicyBindingsResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Matchingresources {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Matchingresources$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Matchingresources$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BindingMatchingResource>>;
        get(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Matchingresources$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Matchingresources$Get, options: MethodOptions | BodyResponseCallback<Schema$BindingMatchingResource>, callback: BodyResponseCallback<Schema$BindingMatchingResource>): void;
        get(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Matchingresources$Get, callback: BodyResponseCallback<Schema$BindingMatchingResource>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Matchingresources$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Matchingresources$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListBindingMatchingResourcesResponse>>;
        list(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Matchingresources$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Matchingresources$List, options: MethodOptions | BodyResponseCallback<Schema$ListBindingMatchingResourcesResponse>, callback: BodyResponseCallback<Schema$ListBindingMatchingResourcesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Autoprotectionpolicies$Bindings$Matchingresources$List, callback: BodyResponseCallback<Schema$ListBindingMatchingResourcesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListBindingMatchingResourcesResponse>): void;
    }
