...
export declare namespace dataflow_v1b3 {
    ...
    export class Resource$Folders$Locations$Configstoresettings {
         ...
         */
        create(params: Params$Resource$Folders$Locations$Configstoresettings$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Folders$Locations$Configstoresettings$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ConfigStoreSetting>>;
        create(params: Params$Resource$Folders$Locations$Configstoresettings$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Folders$Locations$Configstoresettings$Create, options: MethodOptions | BodyResponseCallback<Schema$ConfigStoreSetting>, callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        create(params: Params$Resource$Folders$Locations$Configstoresettings$Create, callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Folders$Locations$Configstoresettings$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Folders$Locations$Configstoresettings$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Folders$Locations$Configstoresettings$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Folders$Locations$Configstoresettings$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Folders$Locations$Configstoresettings$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Folders$Locations$Configstoresettings$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Folders$Locations$Configstoresettings$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ConfigStoreSetting>>;
        get(params: Params$Resource$Folders$Locations$Configstoresettings$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Folders$Locations$Configstoresettings$Get, options: MethodOptions | BodyResponseCallback<Schema$ConfigStoreSetting>, callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        get(params: Params$Resource$Folders$Locations$Configstoresettings$Get, callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Folders$Locations$Configstoresettings$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Folders$Locations$Configstoresettings$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListConfigStoreSettingsResponse>>;
        list(params: Params$Resource$Folders$Locations$Configstoresettings$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Folders$Locations$Configstoresettings$List, options: MethodOptions | BodyResponseCallback<Schema$ListConfigStoreSettingsResponse>, callback: BodyResponseCallback<Schema$ListConfigStoreSettingsResponse>): void;
        list(params: Params$Resource$Folders$Locations$Configstoresettings$List, callback: BodyResponseCallback<Schema$ListConfigStoreSettingsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListConfigStoreSettingsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        resolve(params: Params$Resource$Folders$Locations$Configstoresettings$Resolve, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        resolve(params?: Params$Resource$Folders$Locations$Configstoresettings$Resolve, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ResolveConfigStoreSettingResponse>>;
        resolve(params: Params$Resource$Folders$Locations$Configstoresettings$Resolve, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        resolve(params: Params$Resource$Folders$Locations$Configstoresettings$Resolve, options: MethodOptions | BodyResponseCallback<Schema$ResolveConfigStoreSettingResponse>, callback: BodyResponseCallback<Schema$ResolveConfigStoreSettingResponse>): void;
        resolve(params: Params$Resource$Folders$Locations$Configstoresettings$Resolve, callback: BodyResponseCallback<Schema$ResolveConfigStoreSettingResponse>): void;
        resolve(callback: BodyResponseCallback<Schema$ResolveConfigStoreSettingResponse>): void;
    }
    ...
    export class Resource$Organizations$Locations$Configstoresettings {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Organizations$Locations$Configstoresettings$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Organizations$Locations$Configstoresettings$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ConfigStoreSetting>>;
        create(params: Params$Resource$Organizations$Locations$Configstoresettings$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Organizations$Locations$Configstoresettings$Create, options: MethodOptions | BodyResponseCallback<Schema$ConfigStoreSetting>, callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        create(params: Params$Resource$Organizations$Locations$Configstoresettings$Create, callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        create(callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        /**
         * Deletes an existing ConfigStoreSetting.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Organizations$Locations$Configstoresettings$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Organizations$Locations$Configstoresettings$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Organizations$Locations$Configstoresettings$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Organizations$Locations$Configstoresettings$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Organizations$Locations$Configstoresettings$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         * Gets a ConfigStoreSetting.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Organizations$Locations$Configstoresettings$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Organizations$Locations$Configstoresettings$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ConfigStoreSetting>>;
        get(params: Params$Resource$Organizations$Locations$Configstoresettings$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Organizations$Locations$Configstoresettings$Get, options: MethodOptions | BodyResponseCallback<Schema$ConfigStoreSetting>, callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        get(params: Params$Resource$Organizations$Locations$Configstoresettings$Get, callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        get(callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        /**
         * Lists ConfigStoreSettings.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Organizations$Locations$Configstoresettings$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Organizations$Locations$Configstoresettings$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListConfigStoreSettingsResponse>>;
        list(params: Params$Resource$Organizations$Locations$Configstoresettings$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Organizations$Locations$Configstoresettings$List, options: MethodOptions | BodyResponseCallback<Schema$ListConfigStoreSettingsResponse>, callback: BodyResponseCallback<Schema$ListConfigStoreSettingsResponse>): void;
        list(params: Params$Resource$Organizations$Locations$Configstoresettings$List, callback: BodyResponseCallback<Schema$ListConfigStoreSettingsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListConfigStoreSettingsResponse>): void;
        /**
         * Resolves effective value of a ConfigStoreSetting.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        resolve(params: Params$Resource$Organizations$Locations$Configstoresettings$Resolve, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        resolve(params?: Params$Resource$Organizations$Locations$Configstoresettings$Resolve, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ResolveConfigStoreSettingResponse>>;
        resolve(params: Params$Resource$Organizations$Locations$Configstoresettings$Resolve, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        resolve(params: Params$Resource$Organizations$Locations$Configstoresettings$Resolve, options: MethodOptions | BodyResponseCallback<Schema$ResolveConfigStoreSettingResponse>, callback: BodyResponseCallback<Schema$ResolveConfigStoreSettingResponse>): void;
        resolve(params: Params$Resource$Organizations$Locations$Configstoresettings$Resolve, callback: BodyResponseCallback<Schema$ResolveConfigStoreSettingResponse>): void;
        resolve(callback: BodyResponseCallback<Schema$ResolveConfigStoreSettingResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Configstoresettings {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Configstoresettings$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Configstoresettings$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ConfigStoreSetting>>;
        create(params: Params$Resource$Projects$Locations$Configstoresettings$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Configstoresettings$Create, options: MethodOptions | BodyResponseCallback<Schema$ConfigStoreSetting>, callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        create(params: Params$Resource$Projects$Locations$Configstoresettings$Create, callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        create(callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        /**
         * Deletes an existing ConfigStoreSetting.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Configstoresettings$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Configstoresettings$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Configstoresettings$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Configstoresettings$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Configstoresettings$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         * Gets a ConfigStoreSetting.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Configstoresettings$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Configstoresettings$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ConfigStoreSetting>>;
        get(params: Params$Resource$Projects$Locations$Configstoresettings$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Configstoresettings$Get, options: MethodOptions | BodyResponseCallback<Schema$ConfigStoreSetting>, callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        get(params: Params$Resource$Projects$Locations$Configstoresettings$Get, callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        get(callback: BodyResponseCallback<Schema$ConfigStoreSetting>): void;
        /**
         * Lists ConfigStoreSettings.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Configstoresettings$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Configstoresettings$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListConfigStoreSettingsResponse>>;
        list(params: Params$Resource$Projects$Locations$Configstoresettings$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Configstoresettings$List, options: MethodOptions | BodyResponseCallback<Schema$ListConfigStoreSettingsResponse>, callback: BodyResponseCallback<Schema$ListConfigStoreSettingsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Configstoresettings$List, callback: BodyResponseCallback<Schema$ListConfigStoreSettingsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListConfigStoreSettingsResponse>): void;
        /**
         * Resolves effective value of a ConfigStoreSetting.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        resolve(params: Params$Resource$Projects$Locations$Configstoresettings$Resolve, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        resolve(params?: Params$Resource$Projects$Locations$Configstoresettings$Resolve, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ResolveConfigStoreSettingResponse>>;
        resolve(params: Params$Resource$Projects$Locations$Configstoresettings$Resolve, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        resolve(params: Params$Resource$Projects$Locations$Configstoresettings$Resolve, options: MethodOptions | BodyResponseCallback<Schema$ResolveConfigStoreSettingResponse>, callback: BodyResponseCallback<Schema$ResolveConfigStoreSettingResponse>): void;
        resolve(params: Params$Resource$Projects$Locations$Configstoresettings$Resolve, callback: BodyResponseCallback<Schema$ResolveConfigStoreSettingResponse>): void;
        resolve(callback: BodyResponseCallback<Schema$ResolveConfigStoreSettingResponse>): void;
    }
