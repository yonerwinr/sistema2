...
export declare namespace dataform_v1beta1 {
     ...
     */
    export interface Schema$TriggerEvaluationRecord {
        /**
     ...
     */
    export interface Schema$WorkflowTrigger {
        /**
         * The table update trigger configuration.
         */
        tableUpdateTrigger?: Schema$TableUpdateTrigger;
    }
    /**
     * Represents a trigger configuration for a workflow.
     */
    export interface Schema$WorkflowTriggerConfig {
        /**
         ...
         */
        lastSuccessfulEvaluationTime?: string | null;
        /**
         ...
         */
        recentTriggerEvaluationRecords?: Schema$TriggerEvaluationRecord[];
        /**
         * Required. The trigger definitions to invoke a workflow.
         */
        workflowTriggers?: Schema$WorkflowTrigger[];
    }
    /**
    ...
    export class Resource$Projects$Locations$Repositories {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        deleteLongRunning(params: Params$Resource$Projects$Locations$Repositories$Deletelongrunning, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        deleteLongRunning(params?: Params$Resource$Projects$Locations$Repositories$Deletelongrunning, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        deleteLongRunning(params: Params$Resource$Projects$Locations$Repositories$Deletelongrunning, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        deleteLongRunning(params: Params$Resource$Projects$Locations$Repositories$Deletelongrunning, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        deleteLongRunning(params: Params$Resource$Projects$Locations$Repositories$Deletelongrunning, callback: BodyResponseCallback<Schema$Operation>): void;
    ...
    export class Resource$Projects$Locations$Repositories$Workspaces {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        checkout(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Checkout, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        checkout(params?: Params$Resource$Projects$Locations$Repositories$Workspaces$Checkout, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        checkout(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Checkout, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        checkout(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Checkout, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        checkout(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Checkout, callback: BodyResponseCallback<Schema$Empty>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        deleteBranch(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Deletebranch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        deleteBranch(params?: Params$Resource$Projects$Locations$Repositories$Workspaces$Deletebranch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$DeleteBranchResponse>>;
        deleteBranch(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Deletebranch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        deleteBranch(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Deletebranch, options: MethodOptions | BodyResponseCallback<Schema$DeleteBranchResponse>, callback: BodyResponseCallback<Schema$DeleteBranchResponse>): void;
        deleteBranch(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Deletebranch, callback: BodyResponseCallback<Schema$DeleteBranchResponse>): void;
        deleteBranch(callback: BodyResponseCallback<Schema$DeleteBranchResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchBranches(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Fetchbranches, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchBranches(params?: Params$Resource$Projects$Locations$Repositories$Workspaces$Fetchbranches, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchWorkspaceBranchesResponse>>;
        fetchBranches(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Fetchbranches, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetchBranches(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Fetchbranches, options: MethodOptions | BodyResponseCallback<Schema$FetchWorkspaceBranchesResponse>, callback: BodyResponseCallback<Schema$FetchWorkspaceBranchesResponse>): void;
        fetchBranches(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Fetchbranches, callback: BodyResponseCallback<Schema$FetchWorkspaceBranchesResponse>): void;
        fetchBranches(callback: BodyResponseCallback<Schema$FetchWorkspaceBranchesResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchCurrentBranch(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Fetchcurrentbranch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchCurrentBranch(params?: Params$Resource$Projects$Locations$Repositories$Workspaces$Fetchcurrentbranch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchCurrentWorkspaceBranchResponse>>;
        fetchCurrentBranch(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Fetchcurrentbranch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetchCurrentBranch(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Fetchcurrentbranch, options: MethodOptions | BodyResponseCallback<Schema$FetchCurrentWorkspaceBranchResponse>, callback: BodyResponseCallback<Schema$FetchCurrentWorkspaceBranchResponse>): void;
        fetchCurrentBranch(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Fetchcurrentbranch, callback: BodyResponseCallback<Schema$FetchCurrentWorkspaceBranchResponse>): void;
        fetchCurrentBranch(callback: BodyResponseCallback<Schema$FetchCurrentWorkspaceBranchResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        syncWorkspaceRefs(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Syncworkspacerefs, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        syncWorkspaceRefs(params?: Params$Resource$Projects$Locations$Repositories$Workspaces$Syncworkspacerefs, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SyncWorkspaceRefsResponse>>;
        syncWorkspaceRefs(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Syncworkspacerefs, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        syncWorkspaceRefs(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Syncworkspacerefs, options: MethodOptions | BodyResponseCallback<Schema$SyncWorkspaceRefsResponse>, callback: BodyResponseCallback<Schema$SyncWorkspaceRefsResponse>): void;
        syncWorkspaceRefs(params: Params$Resource$Projects$Locations$Repositories$Workspaces$Syncworkspacerefs, callback: BodyResponseCallback<Schema$SyncWorkspaceRefsResponse>): void;
        syncWorkspaceRefs(callback: BodyResponseCallback<Schema$SyncWorkspaceRefsResponse>): void;
        /**
         * Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning.
         * @example
         * ```js
