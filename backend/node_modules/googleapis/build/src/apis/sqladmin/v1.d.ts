...
export declare namespace sqladmin_v1 {
    ...
    export class Resource$Bluegreendeployments {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Bluegreendeployments$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Bluegreendeployments$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        create(params: Params$Resource$Bluegreendeployments$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Bluegreendeployments$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Bluegreendeployments$Create, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Bluegreendeployments$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Bluegreendeployments$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Bluegreendeployments$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Bluegreendeployments$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Bluegreendeployments$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Bluegreendeployments$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Bluegreendeployments$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BlueGreenDeployment>>;
        get(params: Params$Resource$Bluegreendeployments$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Bluegreendeployments$Get, options: MethodOptions | BodyResponseCallback<Schema$BlueGreenDeployment>, callback: BodyResponseCallback<Schema$BlueGreenDeployment>): void;
        get(params: Params$Resource$Bluegreendeployments$Get, callback: BodyResponseCallback<Schema$BlueGreenDeployment>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Bluegreendeployments$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Bluegreendeployments$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListBlueGreenDeploymentsResponse>>;
        list(params: Params$Resource$Bluegreendeployments$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Bluegreendeployments$List, options: MethodOptions | BodyResponseCallback<Schema$ListBlueGreenDeploymentsResponse>, callback: BodyResponseCallback<Schema$ListBlueGreenDeploymentsResponse>): void;
        list(params: Params$Resource$Bluegreendeployments$List, callback: BodyResponseCallback<Schema$ListBlueGreenDeploymentsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListBlueGreenDeploymentsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        switchover(params: Params$Resource$Bluegreendeployments$Switchover, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        switchover(params?: Params$Resource$Bluegreendeployments$Switchover, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        switchover(params: Params$Resource$Bluegreendeployments$Switchover, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        switchover(params: Params$Resource$Bluegreendeployments$Switchover, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        switchover(params: Params$Resource$Bluegreendeployments$Switchover, callback: BodyResponseCallback<Schema$Operation>): void;
    ...
    export class Resource$Connect {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        resolve(params: Params$Resource$Connect$Resolve, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        resolve(params?: Params$Resource$Connect$Resolve, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ConnectSettings>>;
        resolve(params: Params$Resource$Connect$Resolve, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        resolve(params: Params$Resource$Connect$Resolve, options: MethodOptions | BodyResponseCallback<Schema$ConnectSettings>, callback: BodyResponseCallback<Schema$ConnectSettings>): void;
        resolve(params: Params$Resource$Connect$Resolve, callback: BodyResponseCallback<Schema$ConnectSettings>): void;
